...
- **Продуктовый модуль**: Документы / НДФЛ

---

## 2. Пользовательская проблема (User Problem)
Отсутствие автоматизации фичи "Выгрузка справки НДФЛ в формате XML для отправки через ЭДО" в клинике приводит к ручным рутинным операциям, задержкам обслуживания пациентов и риску человеческой ошибки.
...
1. Пользователь открывает модуль "Документы / НДФЛ".
...
• Модальный компонент в представлении модуля Документы / НДФЛ.
