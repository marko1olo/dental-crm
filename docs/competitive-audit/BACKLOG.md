...
Все 63 канонические фичи из [`FEATURES_REGISTRY.md`](file:///C:/Clinic_MVP/dental-crm/docs/competitive-audit/FEATURES_REGISTRY.md) (IDENT, DentalPRO, iStom), а также 61 дополнительная системная аддендум-фича клинической автономии (Wave 15..25, фичи 64..124) имеют статус **`[РЕАЛИЗОВАНО]`**:
