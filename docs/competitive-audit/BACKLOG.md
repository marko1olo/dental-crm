...
>
> ⚠️ **СТАТУС (2026-09-07 / WAVE 22): ВСЕ 63 ФИЧИ, 9 КИЛЛЕР-МОДУЛЕЙ И 103 КИЛЛЕР-ФИЧИ АВТОНОМИИ ВРАЧА, КЛИНИЧЕСКИХ ПРЕСЕТОВ 1-КЛИКА И СНИЖЕНИЯ ТРЕНИЯ ПОЛНОСТЬЮ РЕАЛИЗОВАНЫ (ВСЕГО 137 ФИЧ: 63 КАНОНИЧЕСКИЕ + 74 АДДЕНДУМ).**  
...
Все 63 канонические фичи из [`FEATURES_REGISTRY.md`](file:///C:/Clinic_MVP/dental-crm/docs/competitive-audit/FEATURES_REGISTRY.md) (IDENT, DentalPRO, iStom), а также 74 дополнительные системные аддендум-фичи клинической автономии (Wave 15..22, фичи 64..137) имеют статус **`[РЕАЛИЗОВАНО]`**:
