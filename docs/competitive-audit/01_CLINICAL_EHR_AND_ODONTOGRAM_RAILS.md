...
> 🛡️ **МАНДАТ 8e & ДОГМАТ 4:** ЦРМ — это не симулятор реальности, а инструмент снижения трения! 1-клик физиологическая норма («Соматически здоров», «Пародонт в норме 1-2 мм»), 1-клик пакеты «под ключ» по 804н, отсутствие `disabled` кнопок, версионный аудит правок дневника («Исправленному верить»).  
> **Статус документа:** Производственная спецификация внедрения (Zero-Mock Blueprint)  
> **Домен:** Клиническая карта (043/у), одонтограмма (FDI 11–48), реестр дефектов, МКБ-10, версионный аудит дневников визитов  
> **Дата:** 2026-09-04  
