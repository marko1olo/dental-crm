...
- **Фронтенд**: `apps/web/src/ImagingView.tsx`, `OrthodonticStudioModal.tsx`, `OrthoPhotoProtocolModal.tsx`, `OrthodonticVisitProtocolWidget.tsx`, `CtPlanningToolbar.tsx`, `ctPlanning*.ts`, `ctPlanningPersistence.ts`, `panoramicMprMath.ts`, `panoramicArch.ts`, `BoneQualityPanel.tsx`, `mprMath.ts`, `mprWorker.ts`, `ImplantCrossSectionPlanner.tsx`, `CephalometricAnalysisModal.tsx`.
