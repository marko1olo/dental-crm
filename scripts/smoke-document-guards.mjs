...
assert(
	!missingOutpatient025uPayloadResult.ok &&
		missingOutpatient025uPayloadResult.statusCode === 409,
...
assert(
	outpatient025uPayloadResult.ok,
	"outpatient medical card 025/u payload must pass creation guard",
);
