...
const MODALS_TO_AUDIT = [
	...
	{ name: "DicomViewerModal", testId: "open-viewer-modal-btn", prefix: "radiology_viewer" },
	...
	{ name: "PatientRecallsHubModal", testId: "open-recall-modal-btn", prefix: "recall_manager" },
	{ name: "ManagerialPnlDashboardModal", testId: "open-pnl-modal-btn", prefix: "managerial_pnl" },
	{ name: "DmsGuaranteeLetterModal", testId: "open-insurance-modal-btn", prefix: "insurance_preauth" },
	...
	{ name: "AnesthesiaQuickBar", testId: "open-anesthesia-protocol-modal-btn", prefix: "anesthesia_protocol" },
	...
	{ name: "EgiszRemdHubModal", testId: "open-egisz-remd-modal-btn", prefix: "egisz_remd" },
	{ name: "LabWorkOrderModal", testId: "open-lab-work-order-modal-btn", prefix: "lab_work_order" },
	{ name: "Billing1CExportModal", testId: "open-1c-modal-btn", prefix: "one_c_export" },
	{ name: "InsuranceContractsPanel", testId: "open-dms-manager-modal-btn", prefix: "dms_manager" },
