...
async function run() {
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Access_Dark.png"),
		fullPage: true,
	});
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Access_Light.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Access_Mobile_Dark.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Access_Mobile_Light.png"),
		fullPage: true,
	});
