...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/crm/patient-communication-timelines`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/integrations/egisz-blank-permissions`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/previous-chat-dialog-histories`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/collaborative-chat-processing-states`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/chat-message-dispatch-statuses`,
		VALID_ORG,
		200,
	);
	await check(
