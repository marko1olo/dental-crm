...
requireIn(
	scheduleSource,
	"Этот секрет относится только к расписанию. Он не разблокирует настройки клиники, Telegram или клинические данные.",
...
requireIn(
	scheduleSource,
	"Настройки, Telegram и клинические данные остаются отдельными зонами доступа.",
...
requireIn(
	...
	"ScheduleView must render an addressable empty state when filters hide all appointments.",
);
requireIn(
	scheduleSource,
