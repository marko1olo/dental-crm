...
const WIDGET_SELECTORS = [
	{ id: 46, selector: '[data-testid="recent-patient-history-widget"]', filename: "proof_recent_patient_history.png" },
	{ id: 47, selector: '[data-testid="custom-crm-task-types-widget"]', filename: "proof_custom_crm_task_types.png" },
	{ id: 50, selector: '[data-testid="crm-email-dispatch-logs-widget"]', filename: "proof_crm_email_dispatch_logs.png" },
	{ id: 56, selector: '[data-testid="cancellation-reasons-two-level-widget"]', filename: "proof_cancellation_reasons_two_level.png" },
	{ id: 58, selector: '[data-testid="advance-deposit-taggings-widget"]', filename: "proof_advance_deposit_taggings.png" },
];

async function generateProofs() {
	console.log("=== Generating Wave 9 Puppeteer Visual Proofs ===");
	...
	await browser.close();
	console.log("=== All Wave 9 Proof Images Generated Successfully ===");
}
