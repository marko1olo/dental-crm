...
async function run() {
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Prices_Dark.png"),
		fullPage: true,
	});
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Prices_Light.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Prices_Mobile_Dark.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Prices_Mobile_Light.png"),
		fullPage: true,
	});
