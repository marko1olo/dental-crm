...
const textToSpeak =
	"Здравствуйте! Меня зовут Анна. Я пациент вашей клиники. Вчера вечером у меня начала болеть правая нижняя челюсть, кажется, это зуб мудрости. Боль очень резкая и отдаёт в ухо.";
...
function generateWav(filename, rate) {
  ...
  `;
	...
	execSync(`powershell -ExecutionPolicy Bypass -File temp_tts.ps1`, {
		stdio: "inherit",
	});
