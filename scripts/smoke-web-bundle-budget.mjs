...
const budgets = [
  { name: "workspace", match: /^workspace-(?!(?:continuity|preload|route-boundary|shell|static-options|ui-labels)-)[\w-]+\.js$/, maxBytes: 500_000, maxGzipBytes: 140_000 },
  ...
  { name: "ct planning implant model", match: /^ct-planning-implant-model-(?!panel-)[\w-]+\.js$/, maxBytes: 8_000, maxGzipBytes: 4_000 },
  ...
  { name: "ct planning export", match: /^ct-planning-export-(?!(?:panel|scenario-panel|scenario-summary)-)[\w-]+\.js$/, maxBytes: 8_000, maxGzipBytes: 4_000 },
  ...
  { name: "ct planning export scenario summary", match: /^ct-planning-export-scenario-summary-[\w-]+\.js$/, maxBytes: 5_000, maxGzipBytes: 3_000 },
  { name: "ct planning export scenario panel", match: /^ct-planning-export-scenario-panel-[\w-]+\.js$/, maxBytes: 5_000, maxGzipBytes: 3_000 },
  { name: "ct planning export panel", match: /^ct-planning-export-panel-[\w-]+\.js$/, maxBytes: 5_000, maxGzipBytes: 3_000 },
  ...
  { name: "main stylesheet", match: /^index-[\w-]+\.css$/, maxBytes: 190_000, maxGzipBytes: 32_000 }
];
