...
const budgets = [
  { name: "workspace", match: /^workspace-(?!(?:continuity|preload|route-boundary|shell|static-options|ui-labels)-)[\w-]+\.js$/, maxBytes: 535_000, maxGzipBytes: 145_000 },
  ...
  { name: "ct planning state", match: /^ct-planning-state-[\w-]+\.js$/, maxBytes: 12_000, maxGzipBytes: 4_000 },
  { name: "ct planning geometry", match: /^ct-planning-geometry-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 4_000 },
  { name: "ct planning measurement plan", match: /^ct-planning-measurement-plan-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 4_000 },
  { name: "ct planning measurement panel", match: /^ct-planning-measurement-panel-[\w-]+\.js$/, maxBytes: 8_000, maxGzipBytes: 6_000 },
  { name: "ct planning workflow plan", match: /^ct-planning-workflow-plan-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning workflow panel", match: /^ct-planning-workflow-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 3_000 },
  { name: "ct planning implant fit", match: /^ct-planning-implant-fit-(?!panel-)[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning implant fit panel", match: /^ct-planning-implant-fit-panel-[\w-]+\.js$/, maxBytes: 8_000, maxGzipBytes: 3_000 },
  { name: "ct planning implant model", match: /^ct-planning-implant-model-(?!panel-)[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning implant model panel", match: /^ct-planning-implant-model-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 3_000 },
  { name: "ct planning reconstruction", match: /^ct-planning-reconstruction-(?!panel-)[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning reconstruction panel", match: /^ct-planning-reconstruction-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning validation", match: /^ct-planning-validation-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning validation panel", match: /^ct-planning-validation-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning export", match: /^ct-planning-export-(?!(?:panel|scenario-panel|scenario-summary)-)[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning viewer restore", match: /^ct-planning-viewer-restore-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  ...
  { name: "ct planning export scenario summary", match: /^ct-planning-export-scenario-summary-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning export scenario panel", match: /^ct-planning-export-scenario-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning export panel", match: /^ct-planning-export-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "ct planning artifact commands", match: /^ct-planning-artifact-commands-[\w-]+\.js$/, maxBytes: 7_000, maxGzipBytes: 3_500 },
  { name: "ct planning artifact panel", match: /^ct-planning-artifact-panel-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  { name: "workspace continuity", match: /^workspace-continuity-[\w-]+\.js$/, maxBytes: 10_000, maxGzipBytes: 5_000 },
  { name: "route recovery", match: /^workspace-route-boundary-[\w-]+\.js$/, maxBytes: 15_000, maxGzipBytes: 6_000 },
  ...
  { name: "main stylesheet", match: /^index-[\w-]+\.css$/, maxBytes: 195_000, maxGzipBytes: 35_000 }
];
