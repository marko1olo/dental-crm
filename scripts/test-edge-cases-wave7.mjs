...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/clinical/non-dental-examination-forms`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/documents/treatment-plan-stages`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/schedule/time-reservations`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/integrations/diagnocat-findings`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/clinical/extended-odontogram-states`,
		VALID_ORG,
		200,
	);
	await check(
