...
async function run() {
  ...
  const outDir = 'C:/Users/Admin/.gemini/antigravity/brain/19527560-fbad-4059-97a2-76c3b38db9cc/scratch';
  
  for (const r of routes) {
    console.log(`Navigating to ${r.path}...`);
    try {
      await page.goto(`http://localhost:5173${r.path}`, { waitUntil: 'networkidle0', timeout: 15000 });
