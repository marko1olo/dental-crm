...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/analytics/lost-patients-filters`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/quick-appointment-confirmations`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/schedule/urgent-schedule-requests`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/analytics/confirmation-performance-reports`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/documents/alternative-treatment-plans`,
		VALID_ORG,
		200,
	);
	await check(
