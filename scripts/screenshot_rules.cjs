...
async function run() {
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Rules_Dark.png"),
		fullPage: true,
	});
	...
	await page.screenshot({
		path: path.join(basePath, "Settings_Rules_Light.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Rules_Mobile_Dark.png"),
		fullPage: true,
	});
	...
	await wait(1000);
	await page.screenshot({
		path: path.join(basePath, "Settings_Rules_Mobile_Light.png"),
		fullPage: true,
	});
