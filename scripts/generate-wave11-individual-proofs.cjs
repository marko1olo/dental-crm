...
const WIDGET_SELECTORS = [
	{ id: 59, selector: '[data-testid="uis-omni-messenger-queues-widget"]', filename: "proof_uis_omni_messenger_queues.png" },
];

async function generateProofs() {
	console.log("=== Generating Wave 11 Puppeteer Visual Proofs ===");
	...
	await browser.close();
	console.log("=== Wave 11 Proof Image Generated Successfully ===");
}
