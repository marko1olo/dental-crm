...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/uis-sms-chat-quotas`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/uis-mass-appointment-confirmations`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/message-template-catalogs`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/documents/ndfl-tax-calculators`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/communications/messenger-file-attachments`,
		VALID_ORG,
		200,
	);
	await check(
