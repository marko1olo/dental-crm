...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/documents/treatment-plan-lock-tokens`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/finance/digital-receipt-dispatches`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/crm/patient-service-lineages`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/integrations/landing-field-mappings`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/finance/kkm-item-quantity-units`,
		VALID_ORG,
		200,
	);
	await check(
