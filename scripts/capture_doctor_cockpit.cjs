...
async function capture() {
	console.log("Launching Chromium for Doctor Shift Cockpit & Header visual audit (Defect 3 & 6 Fix)...");
...
capture()
	.then((results) => {
		console.log("SUCCESS: Screenshot capture and verification completed successfully.");
		process.exit(0);
	})
	.catch((err) => {
