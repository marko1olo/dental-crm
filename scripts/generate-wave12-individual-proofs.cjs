...
const WIDGET_SELECTORS = [
	{ id: 6, selector: '[data-testid="lost-patients-filters-widget"]', filename: "proof_lost_patients_filters.png" },
	{ id: 9, selector: '[data-testid="quick-appointment-confirmations-widget"]', filename: "proof_quick_appointment_confirmations.png" },
	{ id: 21, selector: '[data-testid="urgent-schedule-requests-widget"]', filename: "proof_urgent_schedule_requests.png" },
	{ id: 23, selector: '[data-testid="confirmation-performance-reports-widget"]', filename: "proof_confirmation_performance_reports.png" },
	{ id: 43, selector: '[data-testid="alternative-treatment-plans-widget"]', filename: "proof_alternative_treatment_plans.png" },
];

async function generateProofs() {
	console.log("=== Generating Wave 12 Puppeteer Visual Proofs ===");
	...
	await browser.close();
	console.log("=== All Wave 12 Proof Images Generated Successfully ===");
}
