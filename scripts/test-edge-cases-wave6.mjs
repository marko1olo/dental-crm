...
async function run() {
	...
	await check(
		"200 valid org",
		`${BASE}/api/integrations/prodoctorov-sync`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/clinical/custom-examination-form-catalogs`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/documents/treatment-plan-print-odontogram`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/egisz/multiple-diagnoses`,
		VALID_ORG,
		200,
	);
	await check(
	...
	await check(
		"200 valid org",
		`${BASE}/api/integrations/mkb10-auto-directories`,
		VALID_ORG,
		200,
	);
	await check(
