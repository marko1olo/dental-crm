...
const KNOWN_DEAD_ROUTES = new Set([
	"DELETE /api/anesthesia/logs/:param",
	"DELETE /api/audit/logs",
	"DELETE /api/audit/logs/:param",
	"DELETE /api/finance/family/:param",
	"DELETE /api/perio/charts/:param",
	"DELETE /api/registers/bactericidal/equipments/:param",
	"DELETE /api/registers/pso/:param",
	"GET /api/anesthesia/patients/:param/logs",
	"GET /api/attachments/:param/download",
	"GET /api/auth/status",
	"GET /api/billing/fiscal-queue/pending",
	"GET /api/clinical/implants/patient/:param",
	"GET /api/clinical/lab-orders/:param/events",
	"GET /api/clinical/lab-orders/:param/items",
	"GET /api/communications/inbox",
	"GET /api/communications/inbox/:param",
	"GET /api/communications/patients/search",
	"GET /api/crm/custom-crm-task-types",
	"GET /api/diaries/:param/chief-reviews",
	"GET /api/diary/:param/chief-reviews",
	"GET /api/finance/family/:param",
	"GET /api/fiscal/devices/status",
	"GET /api/fiscal/queue",
	"GET /api/imaging/local-offline/studies/:param",
	...
	"GET /api/integrations/yandex-calendar/feed-url",
	"GET /api/inventory/:param/alerts",
	"GET /api/loyalty/balance/:param",
	"GET /api/loyalty/transactions/:param",
	"GET /api/mdlp/items",
	...
	"GET /api/p/:param",
	"GET /api/payments/sberbank/pos/status/:param",
	"GET /api/perio/charts/:param",
	"GET /api/pharmacology/prescriptions/patient/:param",
	"GET /api/referrals/my-code/:param",
	...
	"GET /api/telephony/:param/sip/status",
	"GET /api/telephony/recordings/:param/stream",
	...
	"POST /api/clinical/implants/installations",
	"POST /api/clinical/lab-orders/:param/events",
	"POST /api/communications/inbox/:param/send",
	"POST /api/diaries/:param/chief-review",
	"POST /api/diaries/sync-progress",
	"POST /api/diary/:param/chief-review",
	"POST /api/documents",
	"POST /api/fiscal/devices/test-connection",
	"POST /api/fiscal/queue/:param/retry",
	...
	"POST /api/insurance/contracts/:param/calculate-coverage",
	...
	"POST /api/perio/calculate-indices",
	"POST /api/pharmacology/check-interactions",
	"POST /api/pharmacology/prescriptions",
	"POST /api/referrals/attribute",
	"POST /api/referrals/reward-first-visit",
	...
	"POST /api/sync/gateway",
	"POST /api/sync/pull",
	"POST /api/sync/push",
	"POST /api/telephony/:param/asterisk/ami-event",
	"POST /api/telephony/:param/sip/credentials",
	"POST /api/telephony/:param/sip/failover",
	"POST /api/telephony/asterisk/ami-event",
	"POST /api/telephony/sip/credentials",
	"POST /api/telephony/sip/failover",
