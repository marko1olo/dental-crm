...
const sources = {
	"apps/api/src/routes/system.ts": fs.readFileSync(
		"apps/api/src/routes/system.ts",
		"utf8",
	),
	"apps/api/src/speech/gateway.ts": fs.readFileSync(
		"apps/api/src/speech/gateway.ts",
		"utf8",
	),
	"apps/api/src/routes/imaging.ts": fs.readFileSync(
		...
		JSON.stringify(
			{
				...
				forbidden,
				reason:
					"Doctor-visible API fallback messages must use Russian fallback text.",
			},
			null,
			2,
		),
