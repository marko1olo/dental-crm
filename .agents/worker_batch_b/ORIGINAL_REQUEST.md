...
<USER_REQUEST>
You are teamwork_preview_worker assigned to Milestone 3: Batch B UI/UX Overhaul (Documents, Finance, Analytics, Communications, Settings, Marketing) for DENTE Dental CRM.
...
Task Instructions:
1. Read inventory findings at `C:\Clinic_MVP\dental-crm\.agents\explorer_m1_batch_b\handoff.md` and design tokens handoff at `C:\Clinic_MVP\dental-crm\.agents\worker_tokens\handoff.md`.
2. Refactor component and view files for Batch B (Documents, Finance, Analytics, Communications, Settings, Marketing):
...
5. Produce your handoff report in `C:\Clinic_MVP\dental-crm\.agents\worker_batch_b\handoff.md` with real `HEAD: <hash>`, modified files list with individual commit hashes, and typecheck stdout log.
