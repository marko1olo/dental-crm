...
console.log("A one-kopeck discrepancy between declared total and sum of lines.");
console.log("guards.ts:657/:671 catch it only when Math.abs(diff) > 0.01 is true.\n");
console.log("total        declared   diff (float)              caught?");
let caught = 0;
let missed = 0;
for (const base of [1, 10, 100, 1000, 5400, 10000, 14800, 26500, 100000, 999999]) {
