...
const web = readFileSync(dir + "web-api-paths.txt", "utf8")
	.split(/\r?\n/)
	.filter(Boolean);
const api = readFileSync(dir + "api-route-literals.txt", "utf8")
	.split(/\r?\n/)
	.filter(Boolean);
...
for (const w of web) {
	...
	const hit = apiNorm.find(
		(a) => a.n === n || n.startsWith(a.n + "/") || a.n.startsWith(n + "/"),
	);
