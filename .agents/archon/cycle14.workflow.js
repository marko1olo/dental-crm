export const meta = {
	...
	description:
		"DENTE cycle 14 (small unit): eleven places print raw floating-point money into Russian sentences a dentist reads",
	phases: [
		{ title: "Build", detail: "one file, one pattern, eleven sites" },
		{
			title: "Attack",
			detail:
				"a different agent checks every site was converted and no comparison changed",
		},
	],
};
...
const PACKETS = [
	{
		...
		files:
			"apps/api/src/documents/guards.ts ONLY, plus a new test file beside it if you add one",
