...
Your working directory is `C:\Clinic_MVP\dental-crm\.agents\reviewer_2`.
...
5. Write your verdict (APPROVE or REQUEST_CHANGES) and handoff report to `C:\Clinic_MVP\dental-crm\.agents\reviewer_2\handoff.md` and notify parent orchestrator.
