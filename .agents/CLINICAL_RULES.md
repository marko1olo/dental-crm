...
## 🧭 1. Фундаментальный клинический принцип: Автономия врача и Zero-Friction (Мандаты 8e и 8n)

> 🎯 **СТРАТЕГИЧЕСКИЙ ПРИОРИТЕТ №1: СОЛО-ВРАЧ И НЕБОЛЬШАЯ КЛИНИКА 1–3 КРЕСЛА (МАНДАТ 8n). ДО БОЛЬШИХ СЕТЕЙ НАМ ЕЩЁ РАСТИ И РАСТИ!**
> 
> Наш главный пользователь прямо сейчас — соло-врач на аренде кресла (ИП, самозанятый) и небольшая клиника на 1–3 установки.
> 1. Вся клиническая эргономика, 0-клик сценарии, 100% автономия врача у кресла, создание записи за 5 сек без обязательного ассистента, 1-клик касса 54-ФЗ без ИНН физлиц, 1-клик списание анестетиков клиническим пакетом — в первую очередь затачиваются под соло-врача и маленькую клинику.
> 2. Сетевые модули закладываются архитектурно по закону отсутствия тупиков (Zero Dead-Ends), но НИКОГДА не навязываются, не маячат перед глазами и не замедляют работу врача у кресла.
...
Пародонтологический модуль (`PeriodontalChartingModal.tsx`, `PeriodontogramChart.tsx`) базируется на каноническом 6-точечном зондировании Формы 043/у Минздрава РФ, классификации AAP/EFP и скрининге ВОЗ PSR:
