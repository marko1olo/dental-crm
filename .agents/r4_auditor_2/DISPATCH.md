...
3. Check for integrity violations (hardcoded test results, facade implementations, dummy mocks circumventing logic).
...
5. Document findings and report explicit verdict (`CLEAN` or `INTEGRITY VIOLATION`) in `C:\Clinic_MVP\dental-crm\.agents\r4_auditor_2\handoff.md`.
