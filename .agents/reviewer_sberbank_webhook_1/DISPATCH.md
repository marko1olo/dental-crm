...
Output Requirements:
Write a comprehensive review report to `C:/Clinic_MVP/dental-crm/.agents/reviewer_sberbank_webhook_1/handoff.md`. State explicit Verdict: `APPROVE` or `REQUEST_CHANGES`. Send a message to parent when complete.
