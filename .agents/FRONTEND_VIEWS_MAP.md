...
> 
> Наш главный пользователь прямо сейчас — **соло-врач на аренде кресла (ИП, самозанятый)** и **небольшая клиника на 1–3 кресла**.
> 1. Все 14 представлений и шторки проектируются так, чтобы соло-врач мог моментально оформить визит, принять оплату по 54-ФЗ без ввода ИНН физлица, распечатать чистые бланки 043/у и списать анестетики в 1 клик без ассистента и лишнего штата.
> 2. Сетевые модули (многофилиальный выбор, тяжелые корпоративные аудиты) закладываются по закону отсутствия тупиков (Zero Dead-Ends), но **никогда не создают визуального шума для соло-врача**.
