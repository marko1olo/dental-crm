...
- Write your completion details into `C:\Clinic_MVP\dental-crm\.agents\r4_worker_3\handoff.md`.
- Maintain heartbeat in `C:\Clinic_MVP\dental-crm\.agents\r4_worker_3\progress.md`.
