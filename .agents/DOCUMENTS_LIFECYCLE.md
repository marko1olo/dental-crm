...
Данный документ содержит полное архитектурное описание жизненного цикла медицинских, юридических и финансовых документов в DENTE CRM: Форма 043/у, ИДС (1051н), Рецепты (107-1/у), Справки ФНС (КНД 1151156), Договоры, Акты выполненных услуг (804н), электронные подписи (ПЭП / УКЭП КриптоПро) и безбарьерная печать (Мандаты 8e и 8n).
...
> 
> Наш главный пользователь — **соло-врач на аренде кресла (ИП, самозанятый)** и **небольшая клиника на 1–3 установки**.
> 1. Вся документарная цепочка ориентирована на нулевое трение: моментальная печать договора со строками `_____` без 403 Forbidden, печать карты 043/у со штампом «ЧЕРНОВИК» на любом этапе, отсутствие требований обязательного ассистента или согласования начмеда.
> 2. Закон отсутствия тупиков (Zero Dead-Ends): отсутствие подключенного модуля УКЭП КриптоПро или ЕГИСЗ не блокирует выдачу пациенту бумажных бланков с синей подписью врача.
