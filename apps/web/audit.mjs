...
const outDir =
	"C:\\Users\\Admin\\.gemini\\antigravity\\brain\\e1a85de0-5463-4dad-9cfd-a687decd3eb2\\.tempmediaStorage";
...
const MOCK_DATA = {
	...
	"/api/dashboard": {
		...
		chairs: [{ id: "c1", name: "Chair 1", isActive: true }],
		clinicSettings: {
			profile: {
				hasPediatricMode: true,
				mode: "enterprise",
...
async function runAudit() {
	...
	const takeScreenshots = async (name, viewport, isDark) => {
		...
		await page.route("**/api/**", async (route) => {
			...
			const sortedEntries = Object.entries(MOCK_DATA).sort(
