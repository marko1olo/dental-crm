...
const oldAdminGrid = '<div className="clinic-profile-form-grid patient-admin-form-grid">';
const newAdminGrid = `
...
const oldCoreGrid = '<div className="clinic-profile-form-grid patient-core-form-grid">';
const newCoreGrid = '<div className="clinic-profile-form-grid patient-core-form-grid" style={{ gridTemplateColumns: "repeat(3, minmax(0, 1fr))" }}>';
