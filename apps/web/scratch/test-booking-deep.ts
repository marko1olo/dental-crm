...
const mockDashboard: any = {
  clinicSettings: {
    staff: [
      { id: "doc1", role: "doctor", fullName: "Иванов Иван Иванович", phone: "123", active: true, specialties: ["терапевт", "хирург"] },
      { id: "doc2", role: "doctor", fullName: "Смирнова Анна", phone: "123", active: true, specialties: ["ортодонт"] },
      { id: "as1", role: "assistant", fullName: "Ассистент Петр", phone: "123", active: true, specialties: [] }
    ],
    chairs: [
      { id: "c1", name: "Кресло 1", active: true, branchId: "b1", settings: {} },
      { id: "c2", name: "Кресло 2", active: true, branchId: "b1", settings: {} }
    ]
  },
  patients: []
};
