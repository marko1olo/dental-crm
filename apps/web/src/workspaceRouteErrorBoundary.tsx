 ...
 * правды — `appViews` — за вычетом «shift»: это стартовый раздел, он грузится сразу
 * и в ленивую обёртку не попадает. Теперь новый раздел в `appViews` автоматически
 * допустим здесь, а раздел, которого в `appViews` нет, перестаёт компилироваться, —
 * то есть эта ошибка больше не возможна.
 *
 ...
 */
export type LazyWorkspaceView = Exclude<AppView, "shift">;
