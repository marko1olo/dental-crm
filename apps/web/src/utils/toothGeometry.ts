...
export const getToothConfig = (toothId: number) => {
	...
	if (num <= 2)
		return { width: "32px", height: "90px", viewWidth: 100, viewHeight: 150 };
	if (num === 3)
		return { width: "36px", height: "90px", viewWidth: 100, viewHeight: 150 };
	if (num <= 5)
		return { width: "44px", height: "90px", viewWidth: 100, viewHeight: 150 };
