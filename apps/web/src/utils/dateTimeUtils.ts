 ...
 *
 * ЧЕМ ВРЕДНО. Отсюда заполняются даты медицинских документов: дата приема
 * карты 043/у и период выписки из медкарты (emptyMedicalRecordExtractDocumentDraftFields
 * — черновик становится начальным состоянием документа). Стоматологическая карта 043/у — форма государственного учёта,
