...
export const useSettingsStore = create<SettingsState & SettingsActions>()(
	(set) => ({
		...
		setClinicMode: (val) =>
			set((state) => ({
				clinicMode:
					typeof val === "function" ? (val as any)(state.clinicMode) : val,
			})),
		setOnboardingDismissed: (val) =>
			set((state) => ({
				onboardingDismissed:
					typeof val === "function"
						? (val as any)(state.onboardingDismissed)
						: val,
			})),
		setOnboardingDismissedAt: (val) =>
			set((state) => ({
				onboardingDismissedAt:
					typeof val === "function"
						? (val as any)(state.onboardingDismissedAt)
						: val,
			})),
		setOnboardingStep: (val) =>
			set((state) => ({
				onboardingStep:
					typeof val === "function" ? (val as any)(state.onboardingStep) : val,
			})),
		setOnboardingDraftMode: (val) =>
			set((state) => ({
				onboardingDraftMode:
					typeof val === "function"
						? (val as any)(state.onboardingDraftMode)
						: val,
			})),
		setOnboardingGuideExpanded: (val) =>
			set((state) => ({
				onboardingGuideExpanded:
					typeof val === "function"
						? (val as any)(state.onboardingGuideExpanded)
						: val,
			})),
		setTelegramHandoffNotice: (val) =>
			set((state) => ({
				telegramHandoffNotice:
					typeof val === "function"
						? (val as any)(state.telegramHandoffNotice)
						: val,
			})),
		setTelegramStatus: (val) =>
			set((state) => ({
				telegramStatus:
					typeof val === "function" ? (val as any)(state.telegramStatus) : val,
			})),
		setTelegramFeaturePlan: (val) =>
			set((state) => ({
				telegramFeaturePlan:
					typeof val === "function"
						? (val as any)(state.telegramFeaturePlan)
						: val,
			})),
		setTelegramOutbox: (val) =>
			set((state) => ({
				telegramOutbox:
					typeof val === "function" ? (val as any)(state.telegramOutbox) : val,
			})),
		setTelegramOutboxStatusFilter: (val) =>
			set((state) => ({
				telegramOutboxStatusFilter:
					typeof val === "function"
						? (val as any)(state.telegramOutboxStatusFilter)
						: val,
			})),
		setTelegramOutboxTemplateFilter: (val) =>
			set((state) => ({
				telegramOutboxTemplateFilter:
					typeof val === "function"
						? (val as any)(state.telegramOutboxTemplateFilter)
						: val,
			})),
		setTelegramLinkCodes: (val) =>
			set((state) => ({
				telegramLinkCodes:
					typeof val === "function"
						? (val as any)(state.telegramLinkCodes)
						: val,
			})),
		setTelegramChatLinks: (val) =>
			set((state) => ({
				telegramChatLinks:
					typeof val === "function"
						? (val as any)(state.telegramChatLinks)
						: val,
			})),
		setTelegramLinkCodeLedger: (val) =>
			set((state) => ({
				telegramLinkCodeLedger:
					typeof val === "function"
						? (val as any)(state.telegramLinkCodeLedger)
						: val,
			})),
		setTelegramChatLinkLedger: (val) =>
			set((state) => ({
				telegramChatLinkLedger:
					typeof val === "function"
						? (val as any)(state.telegramChatLinkLedger)
						: val,
			})),
		setTelegramLinkSubjectType: (val) =>
			set((state) => ({
				telegramLinkSubjectType:
					typeof val === "function"
						? (val as any)(state.telegramLinkSubjectType)
						: val,
			})),
		setTelegramLinkStaffId: (val) =>
			set((state) => ({
				telegramLinkStaffId:
					typeof val === "function"
						? (val as any)(state.telegramLinkStaffId)
						: val,
			})),
		setTelegramLinkCode: (val) =>
			set((state) => ({
				telegramLinkCode:
					typeof val === "function"
						? (val as any)(state.telegramLinkCode)
						: val,
			})),
		setTelegramLinkActionState: (val) =>
			set((state) => ({
				telegramLinkActionState:
					typeof val === "function"
						? (val as any)(state.telegramLinkActionState)
						: val,
			})),
		setTelegramPreview: (val) =>
			set((state) => ({
				telegramPreview:
					typeof val === "function" ? (val as any)(state.telegramPreview) : val,
			})),
		setTelegramModeDraft: (val) =>
			set((state) => ({
				telegramModeDraft:
					typeof val === "function"
						? (val as any)(state.telegramModeDraft)
						: val,
			})),
		setTelegramBotUsernameDraft: (val) =>
			set((state) => ({
				telegramBotUsernameDraft:
					typeof val === "function"
						? (val as any)(state.telegramBotUsernameDraft)
						: val,
			})),
		setTelegramOwnBotUsernameDraft: (val) =>
			set((state) => ({
				telegramOwnBotUsernameDraft:
					typeof val === "function"
						? (val as any)(state.telegramOwnBotUsernameDraft)
						: val,
			})),
		setTelegramBotConfigId: (val) =>
			set((state) => ({
				telegramBotConfigId:
					typeof val === "function"
						? (val as any)(state.telegramBotConfigId)
						: val,
			})),
		setTelegramWebhookBaseUrlDraft: (val) =>
			set((state) => ({
				telegramWebhookBaseUrlDraft:
					typeof val === "function"
						? (val as any)(state.telegramWebhookBaseUrlDraft)
						: val,
			})),
		setTelegramPatientPortalBaseUrlDraft: (val) =>
			set((state) => ({
				telegramPatientPortalBaseUrlDraft:
					typeof val === "function"
						? (val as any)(state.telegramPatientPortalBaseUrlDraft)
						: val,
			})),
		setTelegramWelcomeImageUrlDraft: (val) =>
			set((state) => ({
				telegramWelcomeImageUrlDraft:
					typeof val === "function"
						? (val as any)(state.telegramWelcomeImageUrlDraft)
						: val,
			})),
		setTelegramVisualCardUrlDrafts: (val) =>
			set((state) => ({
				telegramVisualCardUrlDrafts:
					typeof val === "function"
						? (val as any)(state.telegramVisualCardUrlDrafts)
						: val,
			})),
		setTelegramReviewUrlDraft: (val) =>
			set((state) => ({
				telegramReviewUrlDraft:
					typeof val === "function"
						? (val as any)(state.telegramReviewUrlDraft)
						: val,
			})),
		setTelegramMapsUrlDraft: (val) =>
			set((state) => ({
				telegramMapsUrlDraft:
					typeof val === "function"
						? (val as any)(state.telegramMapsUrlDraft)
						: val,
			})),
		setTelegramEnabledFeaturesDraft: (val) =>
			set((state) => ({
				telegramEnabledFeaturesDraft:
					typeof val === "function"
						? (val as any)(state.telegramEnabledFeaturesDraft)
						: val,
			})),
		setTelegramTokenTtlDraft: (val) =>
			set((state) => ({
				telegramTokenTtlDraft:
					typeof val === "function"
						? (val as any)(state.telegramTokenTtlDraft)
						: val,
			})),
		setTelegramReminderLeadTimesDraft: (val) =>
			set((state) => ({
				telegramReminderLeadTimesDraft:
					typeof val === "function"
						? (val as any)(state.telegramReminderLeadTimesDraft)
						: val,
			})),
		setTelegramReviewRequestDelayDraft: (val) =>
			set((state) => ({
				telegramReviewRequestDelayDraft:
					typeof val === "function"
						? (val as any)(state.telegramReviewRequestDelayDraft)
						: val,
			})),
		setTelegramPostVisitCheckupDelayDrafts: (val) =>
			set((state) => ({
				telegramPostVisitCheckupDelayDrafts:
					typeof val === "function"
						? (val as any)(state.telegramPostVisitCheckupDelayDrafts)
						: val,
			})),
		setTelegramAllowVoiceIntakeDraft: (val) =>
			set((state) => ({
				telegramAllowVoiceIntakeDraft:
					typeof val === "function"
						? (val as any)(state.telegramAllowVoiceIntakeDraft)
						: val,
			})),
		setTelegramStaffEscalationChannelDraft: (val) =>
			set((state) => ({
				telegramStaffEscalationChannelDraft:
					typeof val === "function"
						? (val as any)(state.telegramStaffEscalationChannelDraft)
						: val,
			})),
		setTelegramPrivacyModeDraft: (val) =>
			set((state) => ({
				telegramPrivacyModeDraft:
					typeof val === "function"
						? (val as any)(state.telegramPrivacyModeDraft)
						: val,
			})),
		setTelegramSettingsDirty: (val) =>
			set((state) => ({
				telegramSettingsDirty:
					typeof val === "function"
						? (val as any)(state.telegramSettingsDirty)
						: val,
			})),
		setTelegramSettingsSaveState: (val) =>
			set((state) => ({
				telegramSettingsSaveState:
					typeof val === "function"
						? (val as any)(state.telegramSettingsSaveState)
						: val,
			})),
		setTelegramSettingsSaveError: (val) =>
			set((state) => ({
				telegramSettingsSaveError:
					typeof val === "function"
						? (val as any)(state.telegramSettingsSaveError)
						: val,
			})),
		setClinicalAdminSecretDraft: (val) =>
			set((state) => ({
				clinicalAdminSecretDraft:
					typeof val === "function"
						? (val as any)(state.clinicalAdminSecretDraft)
						: val,
			})),
		setSettingsAdminSecretDraft: (val) =>
			set((state) => ({
				settingsAdminSecretDraft:
					typeof val === "function"
						? (val as any)(state.settingsAdminSecretDraft)
						: val,
			})),
		setScheduleAdminSecretDraft: (val) =>
			set((state) => ({
				scheduleAdminSecretDraft:
					typeof val === "function"
						? (val as any)(state.scheduleAdminSecretDraft)
						: val,
			})),
		setTelegramAdminSecretDraft: (val) =>
			set((state) => ({
				telegramAdminSecretDraft:
					typeof val === "function"
						? (val as any)(state.telegramAdminSecretDraft)
						: val,
			})),
		setClinicalAdminSecretSession: (val) =>
			set((state) => ({
				clinicalAdminSecretSession:
					typeof val === "function"
						? (val as any)(state.clinicalAdminSecretSession)
						: val,
			})),
		setSettingsAdminSecretSession: (val) =>
			set((state) => ({
				settingsAdminSecretSession:
					typeof val === "function"
						? (val as any)(state.settingsAdminSecretSession)
						: val,
			})),
		setScheduleAdminSecretSession: (val) =>
			set((state) => ({
				scheduleAdminSecretSession:
					typeof val === "function"
						? (val as any)(state.scheduleAdminSecretSession)
						: val,
			})),
		setTelegramAdminSecretSession: (val) =>
			set((state) => ({
				telegramAdminSecretSession:
					typeof val === "function"
						? (val as any)(state.telegramAdminSecretSession)
						: val,
			})),
		setTelegramSendingItemId: (val) =>
			set((state) => ({
				telegramSendingItemId:
					typeof val === "function"
						? (val as any)(state.telegramSendingItemId)
						: val,
			})),
		setTelegramRevokingLinkId: (val) =>
			set((state) => ({
				telegramRevokingLinkId:
					typeof val === "function"
						? (val as any)(state.telegramRevokingLinkId)
						: val,
			})),
	}),
);
