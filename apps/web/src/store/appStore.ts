...
export const useAppStore = create<AppStore>((set) => ({
  ...
  recognitionKind: (loadUiPreferences() ?? defaultUiPreferences).recognitionKind,
  setRecognitionKind: (val) => set({ recognitionKind: val }),
  recognitionTarget: (loadUiPreferences() ?? defaultUiPreferences).recognitionTarget,
  setRecognitionTarget: (val) => set({ recognitionTarget: val }),
  recognitionText: "",
  setRecognitionText: (val) => set({ recognitionText: val }),
  importSourceKind: (loadUiPreferences() ?? defaultUiPreferences).importSourceKind,
  setImportSourceKind: (val) => set({ importSourceKind: val }),
  smartImportMode: (loadUiPreferences() ?? defaultUiPreferences).smartImportMode,
