...
export type CtPlanningViewerBridgeAdapterTarget =
	| "ohif"
	| "cornerstone"
	| "local_bridge";
export type CtPlanningViewerBridgePixelPolicy =
	| "external_volume_only"
	| "metadata_only_no_pixels";
export type CtPlanningViewerBridgeLaunchGateStatus =
	| "volume_ready"
	| "metadata_ready"
	| "blocked";
...
export function buildCtPlanningViewerBridgeLaunchPayload(input: {
	...
	return {
		...
		pixelPolicy:
			input.manifest.status === "metadata_only"
				? "metadata_only_no_pixels"
				: "external_volume_only",
...
export function buildCtPlanningViewerBridgeLaunchGate(
	...
	const requiredTargets =
		payload.pixelPolicy === "external_volume_only"
			? volumeLaunchTargets
			: metadataLaunchTargets;
