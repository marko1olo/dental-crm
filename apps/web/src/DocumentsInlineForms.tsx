import { type DocumentKind, type DocumentKindMetadata, type DocumentSourceStatus, documentFactoryGroups, type GeneratedDocument, type PatientIntakePregnancyStatus, type Payment, type PhotoVideoConsentMaterial, type PostVisitCareTopic, type ProcedureSpecificConsentProcedure, documentKindMetadata as sharedDocumentKindMetadata, documentSourceStatusLabels as sharedDocumentSourceStatusLabels, type TaxDeductionApplicationDeliveryChannel, type TaxDeductionApplicationForm as TaxDeductionApplicationFormKind, type TaxDeductionApplicationRelationship, type XrayCbctReferralPregnancyStatus, type XrayCbctReferralStudyType } from "@dental/shared";
...
import { documentFormHasEntries, type MedicalDocumentReleaseChannel, useDocumentStore } from "./store/documentStore";
import { EXTRACT_DIAGNOSIS_CHIPS, _EXTRACT_TREATMENT_CHIPS, _EXTRACT_REC_CHIPS, _REFUND_REASON_CHIPS, PAID_CONTRACT_FIELDS_BLOCK_TITLE } from "./DocumentsView";
...
export function MinorLegalRepresentativeConsentForm(props: any) {
