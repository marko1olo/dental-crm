...
function PatientListPanel(props: {
  query: string;
  setQuery: (value: string) => void;
  ...
  createPatient: () => void | Promise<void>;
  patientCreateReady: boolean;
  isPatientCreating: boolean;
  patientCreateGuidance: string | null;
  filteredPatients: Patient[];
  patientInsightById: Map<string, PatientInsight>;
  selectedPatientId: string | undefined | null;
  patientInsightRiskLabels: Record<PatientInsight["riskLevel"], string>;
  money: (amountRub: number) => string;
...
function PatientCoreProfilePanel(props: {
  selectedPatient: Patient | null | undefined;
  ...
  savePatientCore: () => void | Promise<void | boolean>;
  patientCoreReadyToSave: boolean;
  patientCoreSaveGuidanceId: string;
  patientCoreSaveGuidance: string | null;
  ...
  return (
    <>
      ...
      <div className="clinic-profile-form-grid patient-core-form-grid">
        ...
        <label>
          ...
          <input
            ...
            onChange={(event: TextFieldChangeEvent) =>
              updatePatientCoreDraft("phone", event.target.value)
            }
            placeholder="+7..."
          />
        </label>
      ...
      <div className="patient-admin-actions">
        <p>
          ФИО, дата рождения и контакты сразу используются в расписании,
          документах, налоговых формах, Telegram-связи и напоминаниях.
        </p>
        <button
...
function PatientAdministrativeProfilePanel(props: {
  selectedPatient: Patient | null | undefined;
  patientAdministrativeProfileSaveState: PatientAdministrativeProfileSaveState;
  patientAdministrativeProfileValidationMessage: string | null;
  patientAdministrativeProfileDirty: boolean;
  ...
  normalizeOptionalWorkingDaysDraft: (days: number[]) => number[];
  savePatientAdministrativeProfile: () => void | Promise<void | boolean>;
  patientAdministrativeProfileReadyToSave: boolean;
  patientAdministrativeSaveGuidanceId: string;
  patientAdministrativeSaveGuidance: string | null;
}) {
  const {
    selectedPatient,
    patientAdministrativeProfileSaveState,
  ...
  return (
    <>
      ...
      <div className="patient-admin-actions">
        <p>
          Эти данные подставляются в согласия, запросы копий меддокументации и
          расписки о выдаче. Пустые поля не печатаются.
        </p>
        <button
          className="primary-button"
          type="button"
  ...
  return (
    <div className="panel patients-panel" id="patients">
      <PatientListPanel
        ...
        patientCreateReady={patientCreateReady}
        isPatientCreating={isPatientCreating}
        patientCreateGuidance={patientCreateGuidance}
      ...
      >
        <PatientCoreProfilePanel
          ...
          patientCoreReadyToSave={patientCoreReadyToSave}
        ...
        />
        <PatientAdministrativeProfilePanel
          selectedPatient={selectedPatient}
          patientAdministrativeProfileSaveState={
            patientAdministrativeProfileSaveState
          }
          ...
          patientAdministrativeSaveGuidance={patientAdministrativeSaveGuidance}
        />
      </section>
    </div>
  );
