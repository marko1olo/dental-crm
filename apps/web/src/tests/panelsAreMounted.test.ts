...
const DECLARED_UNMOUNTED: ReadonlyArray<{
	...
	{
		file: "components/implant/ImplantPlanningModal.tsx",
		name: "ImplantPlanningModal",
		reason:
			"Интерактивный 3D-планировщик дентальной имплантации с каталогом систем (Straumann, Nobel Biocare, Osstem, Dentium, Astra Tech), проверкой анатомических зон безопасности (нижнечелюстной канал IAN >= 2.0 мм, дно гайморовой пазухи, корни зубов, межимплантатные интервалы >= 3.0 мм), оценкой первичного торка и формированием копеечной сметы.",
	},
	{
		file: "components/voice/VoiceDictationAssistantModal.tsx",
		name: "VoiceDictationAssistantModal",
		reason:
	...
	},
	{
		...
		name: "AnesthesiaProtocolModal",
		reason:
			"Клинический протокол местной анестезии и калькулятор токсической и кардиоваскулярной безопасности доз анестетиков и вазоконстрикторов (СтАР / AHA / Минздрав РФ) с контролем МДД, соматических рисков (ASA I-IV), аспирационной пробы и логированием в форму 043/у.",
	},
	{
		file: "components/sanpin/waste/MedicalWasteJournalModal.tsx",
		name: "MedicalWasteJournalModal",
		reason:
	...
	{
		file: "components/implant/isq/ImplantIsqProtocolModal.tsx",
		name: "ImplantIsqProtocolModal",
		reason:
			"Хирургический протокол контроля первичного торка введения дентальных имплантатов и динамики вторичной остеоинтеграции методом резонансно-частотного анализа (RFA Osstell/Penguin ISQ) с 4-направленными датчиками, оценкой плотности кости по Мишу (D1–D4), выбором протокола нагрузки (немедленная/ранняя/отсроченная) и формированием паспорта имплантата.",
	},
	{
