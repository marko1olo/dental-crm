    ...
    <main className="app-shell dente-redesign" data-collapsed={sidebarCollapsed}>
      ...
      <section className={`workspace view-${currentView}`} id="workspace-content" tabIndex={-1} aria-label="Рабочая область">
        {/*
          ...
          годится — его выставляет только POST /api/workspace/onboarding/complete,
          единственный писатель которого лежит в недостижимом дереве мастера
          (.agents/lead/verdict-onboarding-tree.md), поэтому он не становится
          истинным ни у кого, и баннер висел бы у всех навсегда.
