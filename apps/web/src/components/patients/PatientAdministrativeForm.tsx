...
export function PatientAdministrativeForm({
	...
	return (
		<div className="clinic-profile-form-grid patient-admin-form-grid">
			...
			<p className="field-note form-span-2">
				Удобное окно приёма пациента (начало и конец). Не блокирует сохранение реквизитов (заполните второе или очистите первое).
...
export default PatientAdministrativeForm;
export type {
	PatientAdministrativeProfileDraft,
	PatientAdministrativeFormProps,
	WeekdayOption,
