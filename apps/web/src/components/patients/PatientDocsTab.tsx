		...
		<div className="patient-docs-container">
			...
			<section className="docs-section-card">
				...
				<div className="docs-form-grid">
					...
					<details className="docs-advanced-details" style={{ gridColumn: "1 / -1", marginTop: "1rem" }}>
						<summary style={{ cursor: "pointer", fontWeight: 500, color: "var(--brand-600)", padding: "0.5rem 0", display: "flex", alignItems: "center", gap: "0.5rem" }}>
							<UserCircle size={16} /> Расширенные данные (Представитель, выдача документов)
						</summary>
