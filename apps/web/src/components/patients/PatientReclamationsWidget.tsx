		...
		>
			<div className="panel-heading flex justify-between items-center p-4 bg-rose-50 dark:bg-rose-950/40 border-b border-rose-200 dark:border-rose-900 m-0">
				...
				<button
					...
					className={`border-0 rounded-xl px-4 py-2 min-h-[44px] sm:min-h-[32px] text-xs font-semibold cursor-pointer inline-flex items-center justify-center gap-1.5 transition-all ${
						isAdding
					...
					{isAdding && (
						...
						>
									...
									<div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
										{RECLAMATION_PRESETS.map((preset) => (
											<button
												...
												className="min-h-[44px] sm:min-h-[32px] px-3 py-2 rounded-lg bg-[var(--paper)] hover:bg-[var(--paper-soft)] border border-[var(--line)] text-left text-xs font-semibold text-[var(--ink)] flex items-center gap-1.5 cursor-pointer active:scale-98 transition-all shadow-2xs"
							...
							<div className="flex gap-3 justify-end mt-5">
								<button
									type="button"
									className="ghost-button text-rose-700 dark:text-rose-400 hover:underline cursor-pointer min-h-[44px] sm:min-h-[32px] px-3.5 py-2 inline-flex items-center justify-center"
								...
								<button
									...
									className="primary-button bg-rose-600 hover:bg-rose-700 text-white border-0 px-4 py-2 min-h-[44px] sm:min-h-[32px] rounded-xl font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center"
								>
										...
										<div className="flex justify-between items-start mb-2">
											...
											<div className="flex gap-2">
												<button
													...
													className={`border-0 px-3 py-1.5 rounded-xl text-xs font-semibold cursor-pointer flex items-center gap-1.5 min-h-[44px] sm:min-h-[32px] transition-all ${
														isUnderReview
