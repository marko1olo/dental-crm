...
export const CbctMprViewer: React.FC<CbctMprViewerProps> = ({
	...
	// 4b. Immediate & Burst Re-render on Mode/Geometry Switch (Implant Panel, Tabs, Slices, Themes)
	useEffect(() => {
		renderMprPlanes();
	...
	}, [renderMprPlanes, activeTab, mobileMprSlice, maximizedViewport, cbctImplantMode, invertColors]);
	...
	return (
		...
		>
			...
			<div className="flex-1 flex min-h-0 overflow-hidden relative">
				{/* Romexis-Style Left Tool Dock (44px, Touch & Gloved Standard) */}
				<CbctLeftToolDock
					...
					onResetAll={handleResetViewAndWL}
					invertColors={invertColors}
					onToggleInvertColors={() => setInvertColors((p) => !p)}
