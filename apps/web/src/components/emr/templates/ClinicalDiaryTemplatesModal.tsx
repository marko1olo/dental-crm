...
export const PHYSIOLOGICAL_NORM_PRESET: Clinical1ClickTemplate = {
	...
	defaultAnamnesisMorbi:
		"Соматический анамнез не отягощен. Соматически сохранен, аллергологический статус без особенностей. Перенесенные и сопутствующие соматические заболевания отрицает. Гемотрансфузии, вирусные гепатиты B/C, ВИЧ-инфекцию, туберкулез отрицает. Ранее проходил регулярные профилактические осмотры.",
