...
export const SAMPLE_COMPLIANCE_VISITS: ClinicVisitComplianceItem[] = [
	...
	},
	{
		...
		serviceName: "Лечение генерализованного пародонтита",
		serviceCode: "A16.07.019",
		toothNumber: "11",
		icd10Code: "K05.3",
		diagnosisText: "Хронический пародонтит зуба 1.1",
		isDoctorSignedUkep: false,
		doctorSignatureHash: null,
		isLocked: false,
	...
	},
	{
		id: "comp-007",
		visitId: "vis-107",
		medicalCardNumber: "СТ-2026-0870",
		patientId: "pat-107",
		patientFullName: "Николаев Роман Петрович",
		patientBirthDate: "1991-03-10",
		patientSnils: "144-555-666 77",
		doctorStaffId: "doc-03",
		doctorFullName: "Морозов Артем Павлович",
		doctorSpecialty: "Врач-стоматолог-ортопед",
		visitDate: "2026-08-24",
		visitTime: "18:00",
		encounterIso: "2026-08-24T18:00:00.000Z",
