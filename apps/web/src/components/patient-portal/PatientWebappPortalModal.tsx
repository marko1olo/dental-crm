/**
 * PatientWebappPortalModal.tsx — Модальное окно мобильного веб-кабинета пациента (PWA)
 *
 * (DOMAIN: PATIENT PORTAL & MOBILE WEBAPP PWA)
 *
 * Возможности:
 * 1. Адаптивный мобильный веб-интерфейс пациента (390px / Fullscreen / QR Magic Link).
 ...
 * 3. Переключатель режимов: «Мобильный (390px)» vs «Полный экран» vs «QR Magic Link».
 */
