...
export function ShadowAnalystImageSlider({ imageUrl, enhanced = true, viewerStyle }: ShadowAnalystImageSliderProps) {
  ...
  if (!enhanced) {
    return (
      <div className="sa-image-container" ref={containerRef} style={viewerVariables}>
        <img src={imageUrl} alt="Рентгеновский снимок" className="sa-img-original" />
      </div>
    );
  }
  ...
  return (
    <div
      ...
      style={{ ...viewerVariables, cursor: isDragging ? 'grabbing' : 'col-resize' }}
    >
      {/* Исходный снимок — нижний слой */}
      <img src={imageUrl} alt="Снимок без обработки" className="sa-img-original" />
