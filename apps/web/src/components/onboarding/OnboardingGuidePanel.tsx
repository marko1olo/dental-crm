import { CheckCircle2, Copy, ShieldCheck, Bot, ArrowRight, XCircle, FileText, ChevronRight, Check, ClipboardCheck, CalendarDays, Plus } from "lucide-react";
import { documentFactoryGroups, DentalSpecialty, ClinicMode, StaffRole, PricelistSourceKind, ImportSourceKind, SmartImportMode, DocumentIngestionTarget } from "@dental/shared";
import { showToast } from "../../components/GlobalToast";


export function OnboardingGuidePanel(props: Record<string, any>) {
    // We assume this is rendered inside AppLogicProvider, but just in case, we accept appState prop
    const appState = props.appState;
    const onboardingRoleChoices = props.onboardingRoleChoices;
    const {
        onboardingStep, onboardingSteps, clinicProfileDraft, updateClinicProfileDraft,
        telegramStatus, dashboard, newStaffName, selectedWorkspaceRole,
        moveOnboardingTo, setTelegramAdminSecretDraft, continueOnboardingInDraftMode,
        addStaffMember, addChair, newChairName, setNewChairName, telegramAdminSecretDraft,
        setNewStaffName, setSelectedWorkspaceRole,
        
        telegramPrivacyModeLabels, telegramVisualCardFields, onboardingTelegramVisualCardKeys,
        telegramVisualCardUrlDrafts, updateTelegramVisualCardUrlDraft, telegramFeatureOptions,
        telegramEnabledFeaturesDraft, toggleTelegramFeature, telegramFeatureLabel,
        saveTelegramSettings, isTelegramSettingsSaving, setSettingsTab, telegramSettingsSaveState,
        telegramSettingsSaveError, telegramSettingsDirty, legalReadinessPercent,
        clinicModeLabels, staffRoleLabels, specialtyLabels, selectedSpecialty,
        onboardingDocumentsReady, onboardingReadyToFinish, onboardingBlockingIssues,
        onboardingDocumentReadinessIssues, onboardingTelegramRecommendations, onboardingFinishGuidanceId,
        dismissOnboarding, saveClinicProfileFromDraft, clinicProfileSaveState,
        previousOnboardingStep, nextOnboardingStep, setSelectedSpecialty,
        currentOnboardingIndex, changeClinicMode, uiLanguage, setUiLanguage, normalizeUiLanguageInput, uiLanguageOptions, selectedUiLanguageOption, weekdayOptions, toggleClinicWorkingDay, legalMissingFields, newStaffRole, setNewStaffRole, newStaffSpecialty, setNewStaffSpecialty, newStaffReadyToCreate, onboardingStaffCreateGuidanceId, newChairReadyToCreate, onboardingChairCreateGuidanceId, staffScheduleDrafts, staffScheduleDraftFromWorkingHours, staffScheduleSaveStates, staffScheduleDirtyIds, staffScheduleSavingId, updateStaffScheduleDraft, toggleStaffWorkingDay, saveStaffSchedule, chairScheduleDrafts, chairScheduleSaveStates, chairScheduleDirtyIds, chairScheduleSavingId, updateChairScheduleDraft, toggleChairWorkingDay, saveChairSchedule, pricelistSourceKindLabels, pricelistSourceKind, setPricelistSourceKind, clearPricelistImage, setPricelistAnalysis, importSourceLabels, importSourceKind, setImportSourceKind, setImportPreview, setImportCommit, smartImportModeLabels, smartImportMode, setSmartImportMode, setSmartImportPreview, setSmartImportCommit, ingestionTargetLabels, documentIngestionTarget, setDocumentIngestionTarget, imagingSourceChoices, imagingImportSourceKind, setImagingImportSourceKind, setImagingImportPreview, setImagingImportCommit, setDicomSeriesPreview, imagingSourceLabels, dicomWebEndpointUrl, setDicomWebEndpointUrl, setDicomWebCheck, setDicomViewerLaunchManifest, setDicomViewerToolStateBundle, setDicomViewerWorkbenchManifest, ohifBaseUrl, setOhifBaseUrl, telegramBotUsernameDraft, setTelegramBotUsernameDraft, markTelegramSettingsDirty, telegramPatientPortalBaseUrlDraft, setTelegramPatientPortalBaseUrlDraft, telegramWelcomeImageUrlDraft, setTelegramWelcomeImageUrlDraft, telegramReviewUrlDraft, setTelegramReviewUrlDraft, telegramMapsUrlDraft, setTelegramMapsUrlDraft, telegramTokenTtlDraft, setTelegramTokenTtlDraft, telegramReminderLeadTimesDraft, setTelegramReminderLeadTimesDraft, telegramReviewRequestDelayDraft, setTelegramReviewRequestDelayDraft, telegramPostVisitCheckupDelayFields, telegramPostVisitCheckupDelayDrafts, updateTelegramPostVisitCheckupDelayDraft, unlockTelegramAdminSession, telegramAdminSecretSession, telegramPrivacyModeDraft, setTelegramPrivacyModeDraft, normalizedTelegramPrivacyMode
    } = appState;
