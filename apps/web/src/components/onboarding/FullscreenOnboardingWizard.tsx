...
import { StaffRole, ClinicMode } from "@dental/shared";
import { useState } from "react";


export function FullscreenOnboardingWizard(props: Record<string, any>) {
    const appState = props.appState;
    const onboardingRoleChoices = props.onboardingRoleChoices;
    const [resetting, setResetting] = useState(false);

    const {
        error, onboardingStep, clinicProfileDraft, newStaffName, selectedWorkspaceRole,
        newChairName, continueOnboardingInDraftMode, addStaffMember, addChair, moveOnboardingTo,
        setError, currentOnboardingIndex, onboardingSteps, loadDashboard,
        updateClinicProfileDraft, setSelectedWorkspaceRole, staffRoleLabels,
        setNewStaffName, setNewChairName, previousOnboardingStep, nextOnboardingStep
    } = appState;
