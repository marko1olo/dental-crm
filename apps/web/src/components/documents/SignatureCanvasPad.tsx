import { Check, Eraser, Pen } from "lucide-react";
...
export function SignatureCanvasPad({
	...
	return (
		<div className="flex flex-col gap-4 max-w-2xl mx-auto p-4 bg-zinc-50/40 dark:bg-zinc-950/40 backdrop-blur-md rounded-xl border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm">
			...
			<div className="relative rounded-lg overflow-hidden border-2 border-dashed border-zinc-300/50 dark:border-slate-700 bg-zinc-100/30 dark:bg-slate-800/50">
				{!hasStroke && (
			...
			<div className="flex justify-end gap-3 mt-2">
				{onCancel && (
					<button
						onClick={onCancel}
						className="px-4 py-2 rounded-lg text-slate-600 dark:text-zinc-300 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/50 font-medium transition-colors"
					>
						Отмена
					</button>
				)}
