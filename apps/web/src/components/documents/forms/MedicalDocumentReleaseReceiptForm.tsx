...
export function MedicalDocumentReleaseReceiptForm({ documentPatient, medicalDocumentReleaseChannelLabels, normalizedMedicalDocumentReleaseChannel, releaseProtectionNote, selectedReleaseSourceRequestDocumentId, setReleaseProtectionNote, typedIssuedMedicalCopyRequestDocuments, releaseSourceRequestOptionLabel }: any) {
  const {
