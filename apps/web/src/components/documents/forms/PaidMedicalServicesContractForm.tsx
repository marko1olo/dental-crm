	...
	return (
		<article className="document-payload-card">
			<div>
				...
				<p>
					Фиксация номера, сроков, состава услуг, стоимости, порядка оплаты и
					обязательных уведомлений пациента до лечения.
				</p>
			</div>
				...
				<div className="document-payload-collapsed-content">
					<div className="document-payload-row">
						<label>
							...
							<input
								...
								onChange={(event) => setPaidContractNumber(event.target.value)}
						...
						<label>
							...
							<input
								...
								onChange={(event) => setPaidContractDate(event.target.value)}
							/>
						</label>
					</div>
					<div className="document-payload-row">
					...
					<div className="document-payload-row">
						<label>
							...
							<input
								...
								placeholder={
									documentPatient?.fullName ?? "если не отличается от пациента"
								}
							/>
						</label>
						<label>
							...
							<input
								...
								onChange={(event) =>
									setPaidContractRepresentativeFullName(event.target.value)
								}
							...
							{[
								...
								<button
									...
									onClick={() => {
										...
										setPaidContractCareReason(
											current ? `${current}, ${chip.toLowerCase()}` : chip,
										);
									}}
								>
									+ {chip}
					...
					<label>
						...
						<input
							...
							onChange={(event) => setPaidContractSignedAt(event.target.value)}
						/>
					</label>
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setPaidContractServiceListConfirmed(event.target.checked)
							}
						/>
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setPaidContractWrittenChangesConfirmed(event.target.checked)
							}
						/>
