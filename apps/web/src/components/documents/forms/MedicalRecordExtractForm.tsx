...
export function MedicalRecordExtractForm({
	activeDoctor,
	dashboard,
	documentPatient,
	...
	return (
		<article className="document-payload-card">
			<div>
				...
				<p>
					Только сведения из подписанной медзаписи: период, диагноз, лечение,
					рекомендации и получатель.
				</p>
			</div>
				...
				<div className="document-payload-collapsed-content">
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setRecordExtractThirdPartyDataChecked(event.target.checked)
							}
						/>
