...
export function TaxDeductionApplicationForm({ normalizedTaxApplicationDeliveryChannel, normalizedTaxApplicationForm, normalizedTaxApplicationRelationshipSelect, typedTaxApplicationRelationshipOptions, typedTaxApplicationFormOptions, typedTaxApplicationDeliveryChannelOptions }: any) {
  const {
