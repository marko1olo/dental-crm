...
export function CompletedWorksActForm({ activeDoctor, dashboard, treatmentAcceptancePlannedTotalRub, completedActContractReferenceForUi, completedActFiscalReceiptLines, completedActPaidRubValue, selectedCompletedActContractDocumentId, typedActiveIssuedPaidContracts }: any) {
  const {
    completedActNumber,
