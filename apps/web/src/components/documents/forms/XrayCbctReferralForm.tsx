...
export function XrayCbctReferralForm({ activeDoctor, inferredTreatmentArea, normalizedXrayPregnancyStatus, normalizedXrayPriority, normalizedXrayStudyType, renderClinicalToothRowsEditor, typedXrayStudyTypeOptions, typedXrayPregnancyStatusOptions }: any) {
  const {
    xrayStudyType,
    setXrayStudyType,
    xrayArea,
