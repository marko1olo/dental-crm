...
export function PaymentReceiptForm({ money, paymentFiscalReceiptLabelForUi, paymentReceiptFiscalReceiptLines, paymentReceiptIssuedByValue, paymentReceiptPayerBirthDateValue, paymentReceiptPayerFullNameValue, paymentReceiptPayerIdentityDocumentValue, paymentReceiptPayerInnValue, paymentReceiptPayerRelationshipValue, selectedPaymentReceiptIdSet, selectedPaymentReceiptPayments, selectedPaymentReceiptTotalRub, typedEligiblePaymentReceiptPayments }: any) {
  const {
