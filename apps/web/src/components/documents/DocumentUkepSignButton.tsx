 ...
 *    (apps/api/src/routes/documents.ts:1031-1038) его НЕ вызывает — маршрут
 *    отвечает 404 в живом приложении. Пока это так, единственный возможный исход
 *    подписания — отказ; отказ теперь хотя бы читается по-русски и говорит, что
 *    делать. Комментарий в src/tests/documentsViewDecomposition.test.ts:165-167
