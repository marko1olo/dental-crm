 ...
 *
 * МАНДАТ 8e (Автономия врача и печать в любой момент):
 * Форма ИДС печатается в любой момент в 1 клик: если приём не закрыт — со штампом «ЧЕРНОВИК»,
 * если закрыт — «ПОДПИСАНО ВРАЧОМ / ПАЦИЕНТОМ».
 * Запрещены любые блокировки печати из-за незаполненных полей. Если данных нет — печатаются
 * аккуратные строки «_______» для ручного заполнения на приёме (0 disabled кнопок).
 *
