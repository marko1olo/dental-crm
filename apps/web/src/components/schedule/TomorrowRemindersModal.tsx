			...
			<div className="relative w-full max-w-4xl max-h-[92vh] flex flex-col bg-[var(--paper)] rounded-3xl border-2 border-[var(--teal,var(--brand-primary))]/40 shadow-2xl overflow-hidden">
				...
				<div className="p-4 sm:p-5 border-b border-[var(--line)] flex items-center justify-between gap-3 bg-gradient-to-r from-[var(--teal)]/10 via-[var(--teal)]/5 to-transparent shrink-0">
					...
					<button
						type="button"
						onClick={onClose}
						className="p-2 rounded-xl text-[var(--muted)] hover:text-[var(--ink)] hover:bg-[var(--paper-soft)] transition-all cursor-pointer"
						aria-label="Закрыть"
					>
						<X className="w-6 h-6" />
					</button>
				...
				<div className="px-4 sm:px-5 py-3 border-b border-[var(--line)] bg-[var(--paper-soft)] flex flex-wrap items-center justify-between gap-2 text-xs shrink-0">
					...
					<div className="flex items-center gap-2 flex-wrap">
						<button
							...
							className="px-3 py-1.5 rounded-xl bg-[var(--paper)] border border-[var(--line)] text-[var(--ink)] font-bold hover:bg-[var(--paper-soft)] transition-all cursor-pointer flex items-center gap-1.5 shadow-xs"
						...
						<button
							...
							className="px-3 py-1.5 rounded-xl bg-[var(--teal,var(--brand-primary))] text-white font-black hover:bg-[var(--teal-dark,var(--brand-primary))] transition-all cursor-pointer flex items-center gap-1.5 shadow-xs"
				...
				{/* Search Input */}
				<div className="p-3 sm:px-5 border-b border-[var(--line)] shrink-0">
