		...
		>
				...
				>
					<button
						style={{
							...
							boxShadow:
								activeTool === cornerstoneTools.CrosshairsTool.toolName
									? "0 0 12px rgba(20,184,166,0.2), inset 0 1px 0 rgba(20,184,166,0.15)"
									: "none",
						}}
				...
				{activeTool === "ImplantTool" && (
					...
					>
						<select
							...
							onChange={(e) => {
								const event = new CustomEvent("set-implant-brand", {
						...
						<select
							...
							onChange={(e) => {
								const event = new CustomEvent("set-implant-size", {
									detail: e.target.value,
								});
								window.dispatchEvent(event);
							}}
			...
			>
				...
				>
					...
					>
						{panorexThickness}{" "}
						<span style={{ fontWeight: 400, color: "#52525b" }}>мм</span>
					</span>
					...
					<div style={{ display: "flex", gap: "3px" }}>
						<button
							style={{
								...
								border: "none",
								opacity: panorexThickness === 0 ? 0.4 : 1,
								transition: "all 0.15s ease",
								backgroundColor:
									blendMode === "mip" ? "#3f3f46" : "transparent",
								color: blendMode === "mip" ? "#f4f4f5" : "#52525b",
							}}
						...
						<button
							style={{
								...
								transition: "all 0.15s ease",
								backgroundColor:
									blendMode === "average" ? "#3f3f46" : "transparent",
								color: blendMode === "average" ? "#f4f4f5" : "#52525b",
							}}
