...
const PEDIATRIC_STATUS_OPTIONS: ReadonlyArray<{
	...
	},
	{
		...
		shortCode: "Пл",
		colorClass: "bg-[var(--teal-soft,var(--paper-soft))] text-[var(--teal-dark,var(--teal))] hover:bg-[var(--teal-soft,var(--paper-soft))]/80",
	...
	},
	{
		...
		shortCode: "Кр",
		colorClass: "bg-[var(--paper-soft)] text-[var(--ink)] hover:bg-[var(--paper-soft)]/80",
