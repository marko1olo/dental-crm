...
export const CLINICAL_MATERIALS_CATALOG: readonly ClinicalMaterialDefinition[] = [
	// Композиты и адгезивы
	{
		...
		descriptionRu: "Универсальный наногибридный реставрационный композит (прямое списание FIFO)",
	},
	{
		...
		requiresSerialNumber: false,
		standardPackagingRu: "шприц 4 г",
		descriptionRu: "Светоотверждаемый микронаполненный гибридный композит (прямое списание FIFO)",
	},
	{
		...
		descriptionRu: "Самопротравливающий адгезив 7-го поколения (прямое списание FIFO)",
	},
	{
	...
	// Эндодонтия
	{
		...
		descriptionRu: "Мастер-штифты для трехмерной обтурации корневых каналов (прямое списание FIFO)",
	},
	{
		...
		descriptionRu: "Двухкомпонентный полимерный герметик корневых каналов (прямое списание FIFO)",
	},
	{
		...
		descriptionRu: "Основной антисептический ирригант для растворения органики (прямое списание FIFO)",
	},
	{
		id: "mat_edta_gel_17",
		sku: "ENDO-EDTA-17",
	...
	},
	{
		id: "mat_patient_bib",
		sku: "PPE-PATIENT-BIB",
		nameRu: "Салфетка нагрудная стоматологическая двухслойная (нагрудник)",
		category: "ppe",
		unit: "шт",
		okeiCode: "796",
		defaultUnitCostKopecks: parseKopecks("8.00"),
		requiresLotTracking: false,
		requiresSerialNumber: false,
		standardPackagingRu: "пакет 500 шт",
		descriptionRu: "Защита одежды пациента во время стоматологического приема (нагрудник)",
	},
	{
	...
	},
	{
		...
		descriptionRu: "Удаление мягкого налета и биопленки с эмали зубов (прямое списание FIFO)",
	},
	{
		id: "mat_prophy_paste",
	...
	},
	{
		...
		descriptionRu: "Глубокое фторирование и снижение гиперестезии эмали (прямое списание FIFO)",
	},
	{
		id: "mat_bio_oss_graft",
		sku: "SURG-BIO-OSS-05",
		nameRu: "Костнозамещающий натуральный графт Geistlich Bio-Oss (гранулы 0.5 г / 1.0 г)",
		category: "surgery",
		unit: "упак",
		okeiCode: "796",
		defaultUnitCostKopecks: parseKopecks("12500.00"),
		requiresLotTracking: true,
		requiresSerialNumber: true,
		standardPackagingRu: "стерильный флакон 0.5 г",
		descriptionRu: "Натуральный остеокондуктивный костнозамещающий материал (Швейцария)",
	},
	{
		id: "mat_bio_gide_membrane",
		sku: "SURG-BIO-GIDE-25",
		nameRu: "Коллагеновая резорбируемая барьерная мембрана Geistlich Bio-Gide 25×25 мм",
		category: "surgery",
		unit: "шт",
		okeiCode: "796",
		defaultUnitCostKopecks: parseKopecks("16800.00"),
		requiresLotTracking: true,
		requiresSerialNumber: true,
		standardPackagingRu: "стерильный блистер",
		descriptionRu: "Двухслойная свиная коллагеновая мембрана для направленной костной регенерации",
	},
	{
		id: "mat_prolene_50",
		sku: "SUT-PROL-50",
		nameRu: "Шовный материал монофиламентный Пролен (Prolene) 5-0 с атравматической иглой",
		category: "suture",
		unit: "шт",
		okeiCode: "796",
		...
		requiresSerialNumber: false,
		standardPackagingRu: "пакет с нитью",
		descriptionRu: "Нерассасывающаяся полипропиленовая мононить для прецизионного ушивания десны",
	},
	{
		id: "mat_estelite_asteria",
		sku: "COMP-ESTEL-AST",
		nameRu: "Светоотверждаемый нанокомпозит Estelite Asteria (шприц 4 г, Tokuyama Dental)",
		category: "composite",
		unit: "г",
		okeiCode: "166",
		defaultUnitCostKopecks: parseKopecks("1450.00"),
		requiresLotTracking: false,
		requiresSerialNumber: false,
		standardPackagingRu: "шприц 4 г",
		descriptionRu: "Высокоэстетичный светоотверждаемый нанокомпозит с эффектом хамелеона (прямое списание FIFO)",
	},
	{
		id: "mat_articaine_1_200000",
		sku: "ANES-ULTRA-DS-200",
		nameRu: "Анестетик артикаиновый 4% с эпинефрином 1:200 000 (Ультракаин Д-С) 1.7 мл",
		category: "anesthesia",
		unit: "карп",
		okeiCode: "796",
		defaultUnitCostKopecks: parseKopecks("210.00"),
		...
		requiresSerialNumber: false,
		standardPackagingRu: "карпула 1.7 мл",
		descriptionRu: "Местный анестетик артикаинового ряда с уменьшенной концентрацией вазоконстриктора",
	},
];
...
export const DENTAL_CABINET_STOCK_PRESETS: readonly CabinetStockBatch[] = [
	{
		batchId: "bat_bio_oss_01",
		materialId: "mat_bio_oss_graft",
		cabinetId: "cab_02_surgery",
		cabinetNameRu: "Кабинет №2 (Хирургия)",
		lotNumber: "LOT-BIO-OSS-771",
		serialNumber: "SN-OSS-90218",
		expirationDate: "2028-10-31",
		manufactureDate: "2024-10-01",
		quantityAvailable: 6, // 6 упаковок
		criticalThreshold: 2,
		unitCostKopecks: parseKopecks("12500.00"),
		supplierNameRu: "Geistlich Pharma AG (Швейцария)",
	},
	{
		batchId: "bat_bio_gide_01",
		materialId: "mat_bio_gide_membrane",
		cabinetId: "cab_02_surgery",
		cabinetNameRu: "Кабинет №2 (Хирургия)",
		lotNumber: "LOT-BIO-GIDE-442",
		serialNumber: "SN-GIDE-10492",
		expirationDate: "2028-12-31",
		manufactureDate: "2024-12-01",
		quantityAvailable: 4, // 4 мембраны
		criticalThreshold: 1,
		unitCostKopecks: parseKopecks("16800.00"),
		supplierNameRu: "Geistlich Pharma AG (Швейцария)",
	},
	{
		batchId: "bat_prolene_01",
		materialId: "mat_prolene_50",
		cabinetId: "cab_02_surgery",
		cabinetNameRu: "Кабинет №2 (Хирургия)",
		lotNumber: "LOT-PROL-119",
		expirationDate: "2029-05-31",
		manufactureDate: "2024-05-01",
		quantityAvailable: 15,
		criticalThreshold: 5,
		unitCostKopecks: parseKopecks("540.00"),
		supplierNameRu: "Ethicon (Johnson & Johnson)",
	},
	{
		batchId: "bat_estelite_01",
		materialId: "mat_estelite_asteria",
		cabinetId: "cab_01_therapy",
		cabinetNameRu: "Кабинет №1 (Терапия)",
		lotNumber: "LOT-EST-3301",
		expirationDate: "2028-08-31",
		manufactureDate: "2025-01-15",
		quantityAvailable: 8.0, // 8 г (2 шприца)
		criticalThreshold: 2.0,
		unitCostKopecks: parseKopecks("1450.00"),
		supplierNameRu: "Tokuyama Dental (Япония)",
	},
	{
		batchId: "bat_articaine_200_01",
		materialId: "mat_articaine_1_200000",
		cabinetId: "cab_01_therapy",
		cabinetNameRu: "Кабинет №1 (Терапия)",
		lotNumber: "LOT-ULT-200-881",
