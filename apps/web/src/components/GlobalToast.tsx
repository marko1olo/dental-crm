...
export function GlobalToast() {
	...
	return (
		<div
			className={`fixed bottom-6 right-6 z-[9999] flex items-center gap-3 px-5 py-3.5 rounded-xl shadow-2xl backdrop-blur-xl border ${bgColors[toast.type]} animate-in slide-in-from-bottom-5 fade-in duration-300 max-w-sm`}
		>
			{iconMap[toast.type]}
