...
export function DmsGuaranteeLetterModal({
	...
	const handleActivateEmergencyPainMode = () => {
		...
		setNotes(
			"⚡ Экстренный приём / Гарантия в пути (лечение начато без ожидания письма, устное подтверждение куратора). Временное согласование неотложных манипуляций (депульпирование, анестезия, вскрытие абсцесса) без блокировки кассы или приёма (Мандат 8e).",
		);
		showToast(
