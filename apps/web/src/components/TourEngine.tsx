		...
		steps: [
			{
				...
				content:
					"Используйте кнопку «+ Запись» для быстрого создания нового визита пациента в календарь.",
				placement: "bottom",
				view: "schedule",
			},
			{
				...
				content:
					"Здесь отображаются все запланированные приемы. Вы можете перетаскивать их для изменения времени.",
				placement: "top",
				view: "schedule",
			},
		],
		...
		steps: [
			{
				...
				content:
					"Введите ФИО или номер телефона пациента для мгновенного поиска его амбулаторной карты.",
				placement: "bottom",
				view: "patients",
			},
			{
				...
				content:
					"Вся персональная, контактная и медицинская информация о пациенте сосредоточена в этой карточке.",
				placement: "left",
				view: "patients",
			},
		],
		...
		steps: [
			{
				...
				content:
					"Нажмите на любой зуб, чтобы отметить кариес, пломбу или отсутствие зуба в круговом меню.",
				placement: "top",
				view: "patients",
			},
			{
				targetSelector:
					'button[style*="Групповой выбор"], .odontogram-card button',
				title: "Групповой выбор зубов",
				content:
					"Включите групповой выбор для быстрого применения одного статуса к нескольким зубам одновременно.",
				placement: "bottom",
				view: "patients",
			},
		],
		...
		steps: [
			{
				...
				content:
					"Назначьте статус зуба на формуле (например, Caries или Crown) — это автоматически создаст план лечения.",
				placement: "top",
				view: "patients",
			},
			{
				targetSelector:
					'.odontogram-treatment-area, [className*="treatment"], .patient-admin-panel',
				title: "План лечения и смета",
				content:
					"Вся калькуляция стоимости услуг, группировка по фазам и печать согласий выполняются в этой зоне.",
				placement: "left",
				view: "patients",
			},
		],
		...
		steps: [
			{
				...
				content:
					"Здесь отображаются все счета пациентов, статусы оплаты и графики рассрочек.",
				placement: "top",
				view: "finance",
			},
			{
				...
				content:
					"Используйте этот блок для приема наличной/безналичной оплаты от пациента и печати чеков.",
				placement: "bottom",
				view: "finance",
			},
		],
...
export default function TourEngine() {
	...
	return (
		<div className="tour-engine-overlay">
			<div
				className="tour-engine-backdrop"
