...
export const DEFAULT_CONTACTS: readonly PatientOmnichannelContact[] = [
	...
	{
		id: "pat-103",
		fullName: "Пациент клиники (С.В.)",
		phone: "+7 (903) 111-22-33",
		email: "patient.103@example.com",
		preferredChannel: "whatsapp",
		whatsappNumber: "+79031112233",
		telegramUsername: "patient_103",
		avatarColor: "#e11d48",
		unreadCount: 2,
...
export const DEFAULT_NPS_REVIEWS: readonly NpsReview[] = [
	...
	},
	{
		id: "nps-2",
		patientId: "pat-102",
		patientName: "Пациент клиники (М.С.)",
		phone: "+7 (925) 780-99-11",
		score: 10,
		category: "promoter",
		urgency: "low",
	...
	},
	{
		id: "nps-3",
		patientId: "pat-103",
		patientName: "Пациент клиники (С.В.)",
		phone: "+7 (903) 111-22-33",
		score: 4,
		category: "detractor",
		urgency: "critical",
