...
/**
 * 1-клик каноническая норма сложного удаления зуба с разъединением корней и ушиванием.
 */
export const COMPLEX_EXTRACTION_NORM_TEXT =
	"Инфильтрационная и проводниковая анестезия Sol. Articaini 4% 1:100 000 — 3.4 мл. Разрез слизистой оболочки, отслаивание слизисто-надкостничного лоскута. Сепарация корней бором с водяным охлаждением. Люксация элеватором, атравматичная тракция фрагментов корней щипцами. Тщательный кюретаж лунки острой ложкой, удаление грануляций. Антисептическая обработка 0.05% хлоргексидином. Местный гемостаз губкой Альвожил. Сближение краев лунки, наложение швов (швы Викрил 4-0). Давящий марлевый тампон. Гемостаз полный. Рекомендации даны.";

/**
 * 1-клик каноническая норма периостотомии с дренированием при остром гнойном периостите.
 */
