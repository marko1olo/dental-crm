...
export const _viewLabels = workspaceViewLabels as Record<string, string>;
export const _staffCreationRoles: StaffRole[] = [
	"doctor",
	"administrator",
	"assistant",
	"manager",
];
export const _clinicalRuleOwnerRoles: StaffRole[] = [
	"doctor",
	"assistant",
	"administrator",
	"manager",
...
export const _dicomRenderCachePriorityLabels: Record<
...
export const _humanizeIntegrationInput = (value: string) =>
	integrationInputLabels[value] ?? humanizeMigrationText(value);
export const _localBridgeEndpointSummary = (
...
export const _aiRecognitionWarningText = (warning: string) =>
