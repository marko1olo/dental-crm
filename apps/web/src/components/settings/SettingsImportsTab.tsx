				...
				>
					<div className="import-copy">
						...
						<div>
							...
							<h2>Единый вход для пациентов, снимков и неструктурированных данных</h2>
							<p>
								Вставьте смешанную выгрузку из предыдущей МИС, RVG-папки, Excel, OCR
								или диктовки. CRM автоматически классифицирует записи, покажет точность
						...
						{typedImagingFolderScan ? (
							<div className="recognition-notes">
								<span>
									...
									предпросмотре:{" "}
									{typedImagingFolderScan.preview?.totalRows ?? 0}.
								</span>
							...
							>
								<div className="dicom-folder-workup-head">
									<strong>
										...
										/ файлов{" "}
										{typedDicomFolderWorkupPlan.folder?.filesParsed ?? 0}
									</strong>
									<span>
										{humanizeMigrationText(
										...
										.map((plan, idx) => (
											...
											>
												...
												<small>
													...
													память {plan?.renderCachePlan?.gpuMemoryBudgetMb ?? 0}{" "}
													МБ
												</small>
