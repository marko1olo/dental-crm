				...
				<div className="plan-comparator-body">
							...
							return (
								...
								>
									...
									<div>
										...
										<p style={{ fontSize: "0.8125rem", color: "var(--plan-text-muted)", margin: "4px 0 0 0" }}>
											{v.implantSystem}
										</p>
									</div>
									...
									<div className="plan-card-cost">
										...
										<span className="plan-card-cost-sub">
											/ {v.totalVisitsCount} визитов ({v.totalDurationWeeks} нед.)
										</span>
									</div>
					...
					<section className="plan-roadmap-section">
						<h4 className="plan-roadmap-title">
							<Clock size={18} style={{ color: "var(--plan-primary)" }} />
						...
						<div className="plan-roadmap-stages">
							{currentVariant.stages.map((stage) => (
								<div key={stage.stageIndex} className="plan-stage-step">
									...
									<div>
										<strong style={{ fontSize: "0.875rem" }}>{stage.title}</strong>
					...
					<section className="plan-roadmap-section">
						<div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px" }}>
							<h4 className="plan-roadmap-title" style={{ margin: 0 }}>
								<Wallet size={18} style={{ color: "var(--plan-primary)" }} />
							...
							{activePaymentTab === "staged" && (
								<>
									<div className="plan-payment-card active">
										...
										<strong style={{ fontSize: "1.125rem", color: "var(--plan-text-main)" }}>
											{currentPayments.stagedPayment.stage1DiagnosticRub.toLocaleString("ru-RU")} ₽
										</strong>
										<span style={{ fontSize: "0.75rem" }}>При заключении договора</span>
									</div>
									...
									<div className="plan-payment-card active">
										...
										<span style={{ fontSize: "0.75rem" }}>В день операции имплантации</span>
									</div>
									...
									<div className="plan-payment-card active">
										...
										<span style={{ fontSize: "0.75rem" }}>При постоянной фиксации коронок</span>
									</div>
								</>
							)}
							...
							{activePaymentTab === "discount" && (
								<>
									<div className="plan-payment-card active">
										...
										<strong style={{ fontSize: "1.125rem", color: "var(--plan-success)" }}>
											- {currentPayments.singlePaymentWith5PctDiscount.discountRub.toLocaleString("ru-RU")} ₽ (5%)
										</strong>
										<span style={{ fontSize: "0.75rem" }}>Экономия бюджета пациента</span>
									</div>
									...
									<div className="plan-payment-card active" style={{ gridColumn: "span 2" }}>
										...
										<strong style={{ fontSize: "1.375rem", color: "var(--plan-primary)" }}>
											{currentPayments.singlePaymentWith5PctDiscount.finalPayableRub.toLocaleString("ru-RU")} ₽
										</strong>
										<span style={{ fontSize: "0.75rem" }}>100% предоплата перед началом лечения</span>
									</div>
								</>
							)}
								...
								<>
									{currentPayments.installments.map((inst) => (
										<div key={inst.months} className="plan-payment-card active">
											...
											<strong style={{ fontSize: "1.25rem", color: "var(--plan-primary)" }}>
												{inst.monthlyPaymentRub.toLocaleString("ru-RU")} ₽/мес.
											</strong>
											<span style={{ fontSize: "0.75rem", color: "var(--plan-success)" }}>
									...
									<div className="plan-payment-card active" style={{ gridColumn: "span 3" }}>
										<div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
											<div>
												...
												<div style={{ fontSize: "1.25rem", fontWeight: 800, color: "var(--plan-success)", marginTop: "2px" }}>
											...
											<div style={{ textAlign: "right" }}>
												...
												<div style={{ fontSize: "1.25rem", fontWeight: 800, color: "var(--plan-primary)" }}>
				...
				<footer className="plan-comparator-footer">
					<div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
						<div style={{ fontSize: "0.875rem" }}>
							Выбран план: <strong>{currentVariant.title}</strong> ({currentVariant.totalCostRub.toLocaleString("ru-RU")} ₽)
						</div>
					</div>
