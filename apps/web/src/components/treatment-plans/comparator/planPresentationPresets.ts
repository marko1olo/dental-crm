		...
		stages: [
			{
				...
				subtitle: "Комплексная санация, гигиена и 3D-хирургический шаблон",
				durationWeeks: 2,
				visitsCount: 2,
				costRub: 45000,
				keyProcedures: [
			...
			{
				stageIndex: 4,
				title: "Этап 4: Ортодонтия & Профконтроль",
				subtitle: "Гнатологическая защита, ретенция и диспансерный мониторинг",
				durationWeeks: 2,
				visitsCount: 1,
				costRub: 20000,
				keyProcedures: [
					"Окклюзионный анализ T-Scan и защитная сплинт-каппа",
					"Контрольная 3D-томография остеоинтеграции",
					"Гарантийный паспорт и график профосмотров",
				],
			},
		],
		procedures: [
	...
	standard_recommended: {
		...
		stages: [
			...
			},
			{
				stageIndex: 4,
				title: "Этап 4: Ортодонтия & Профконтроль",
				subtitle: "Окклюзионная стабилизация, ретенция и контрольный осмотр",
				durationWeeks: 1,
				visitsCount: 1,
				costRub: 12000,
				keyProcedures: [
					"Контрольная КЛКТ-томография остеоинтеграции",
					"Окклюзионная юстировка и полировка контактов",
					"Диспансерный график гигиены раз в 6 месяцев",
				],
			},
		],
		procedures: [
		...
		stages: [
			{
				stageIndex: 1,
				title: "Этап 1: Терапия & Гигиена",
				subtitle: "Подготовка и санация опорных зубов под коронки",
				durationWeeks: 1,
				visitsCount: 2,
				costRub: 45000,
				keyProcedures: [
					"Профгигиена ультразвуком",
					"Санация кариозных полостей",
			...
			},
			{
				stageIndex: 2,
				title: "Этап 2: Дентальная имплантация",
				subtitle: "Хирургическая подготовка ложа (без имплантации)",
				durationWeeks: 1,
				visitsCount: 1,
				costRub: 10000,
				keyProcedures: [
					"Устранение поддесневых костных выступов / экзостозов",
			...
			},
			{
				stageIndex: 3,
				title: "Этап 3: Протезирование на цирконии",
				subtitle: "Металлокерамика CoCr и бюгельное протезирование",
				durationWeeks: 1,
				visitsCount: 1,
				costRub: 80000,
				keyProcedures: [
			...
			},
			{
				stageIndex: 4,
				title: "Этап 4: Ортодонтия & Профконтроль",
				subtitle: "Адаптация съемного протеза и окклюзионный контроль",
				durationWeeks: 1,
				visitsCount: 1,
				costRub: 10000,
				keyProcedures: [
					"Контрольный осмотр и коррекция базиса протеза",
					"Обучение гигиене съемных конструкций",
				],
			},
		],
		procedures: [
