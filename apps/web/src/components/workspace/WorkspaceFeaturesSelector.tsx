...
interface FeatureToggleDef {
  key: keyof Pick<
    ...
    "hasAssistants" | "hasMultipleChairs" | "hasDentalLab" | "hasInsuranceCoPay" | "hasInstallments"
  >;
  label: string;
  description: string;
...
export function WorkspaceFeaturesSelector() {
  ...
  async function handleToggle(key: keyof WorkspaceFeatureFlags, value: boolean) {
    setSaving(key);
    try {
