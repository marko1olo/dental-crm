		...
		>
			<div className="visit-note-head flex items-center justify-between gap-3 flex-wrap">
				...
				<div className="flex items-center gap-2.5 flex-wrap">
					...
					>
						...
						<span className="hidden sm:inline">Записать на след. этап (+5 дней)</span>
						<span className="sm:hidden">След. этап (+5д)</span>
					</button>
					<span
			...
			>
				...
				<button
					...
					className="shrink-0 min-h-[32px] h-8 px-2.5 py-1 text-xs font-bold rounded-lg border border-[var(--line)] bg-[var(--paper-soft)] text-[var(--ink)] hover:bg-[var(--teal-soft)] hover:text-[var(--teal-dark)] hover:border-[var(--teal)] transition-all cursor-pointer inline-flex items-center gap-1.5 whitespace-nowrap shadow-2xs"
				...
				<button
					...
					className="shrink-0 min-h-[32px] h-8 px-2.5 py-1 text-xs font-bold rounded-lg border border-emerald-500/30 bg-emerald-500/10 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-500/20 transition-all cursor-pointer inline-flex items-center gap-1.5 whitespace-nowrap shadow-2xs"
