/**
 * apps/web/src/components/visit/__tests__/visitServiceBillingWidget.test.tsx
 *
 ...
 * - Mandate 8s: Single Indivisible Authority (canonical component in components/visit).
