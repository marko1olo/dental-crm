...
export const CLINICAL_SOAP_PRESETS: readonly ClinicalSoapPreset[] = [
	...
	{
		id: "caries_medium",
		title: "Кариес дентина (K02.1) — OptiBond FL + Estelite",
		shortBadge: "Кариес",
		category: "therapy",
		icd10: "K02.1",
	...
	{
		id: "pulpitis_acute",
		title: "Острый пульпит (K04.0) — ProTaper + AH Plus + Гуттаперча",
		shortBadge: "Пульпит",
		category: "therapy",
		icd10: "K04.0",
		...
		treatmentDescription: "Инфильтрационная/проводниковая анестезия (Артикаин 4% с эпинефрином 1:100 000 1.7 мл). Раскрытие полости зуба, создание прямого эндодонтического доступа. Коффердам. Витальная экстирпация пульпы пульпоэкстрактором. Определение рабочей длины корневых каналов (апекслокатор + визиография). Машинная мехобработка каналов Ni-Ti ротационными файлами ProTaper Gold (SX, S1, S2, F1, F2) под контролем эндомотора. Обильная ирригация 3% раствором гипохлорита натрия (NaOCl 3%) с ультразвуковой активацией и 17% гелем ЭДТА. Высушивание стерильными бумажными штифтами. Постоянная трехмерная обтурация корневых каналов: эпоксидный силер AH Plus (Dentsply) + калиброванная гуттаперча (гуттаперчевые конусные штифты). Контрольная радиовизиография качества пломбирования каналов до физиологического апекса. Временная герметичная повязка / СИЦ пломба.",
		anesthetic: { drugKey: "ultracain_ds_forte", drugName: "Ультракаин Д-С Форте 1:100 000", carpulesCount: 1.0, volumeMl: 1.7 },
		...
		additionalServices804n: [{ code804n: "A16.07.030.001", title: "Экстирпация пульпы и инструментальная обработка канала ProTaper", basePriceRub: 4000, category: "therapy" }],
		materialsToDeduct: [
	...
	// ── 3. K05.3 ХРОНИЧЕСКИЙ ПАРОДОНТИТ ──
	{
		...
		title: "Хронический пародонтит (K05.3) — УЗ + AirFlow (глицин) + Хлоргексидин 0.05%",
	...
	// ── 4. K01.1 РЕТИНИРОВАННЫЙ ЗУБ / ПРОСТОЕ УДАЛЕНИЕ ──
	{
		...
		title: "Ретинированный зуб / Удаление (K01.1) — Элеватор + Альвожель/Губка",
		shortBadge: "Удален",
		category: "surgery",
		icd10: "K01.1",
		...
		treatmentDescription: "Инфильтрационная и проводниковая анестезия (Артикаин 4% с эпинефрином 1:100 000 — 1.7 мл). Синдесмотомия круговой связки зуба прямым распатором. Атравматичная люксация элеватором (прямым/штыковидным), аккуратная элевация и тракция зуба из альвеолы без повреждения кортикальной пластинки. Тщательный ревизионный кюретаж лунки острой ложкой, удаление грануляций. Антисептическая обработка 0.05% хлоргексидином. Местный гемостаз: внесение в лунку кровоостанавливающей антисептической губки / Альвожель (Альвостаз). Сближение краев лунки, наложение узловых швов (шовный материал Викрил / PTFE 4-0). Давящий марлевый тампон на 20 минут. Контрольный осмотр через 3 дня.",
		anesthetic: { drugKey: "ultracain_ds_forte", drugName: "Ультракаин Д-С Форте 1:100 000", carpulesCount: 1.0, volumeMl: 1.7 },
		...
		materialsToDeduct: [
			{ name: "Гемостатическая коллагеновая губка с антисептиком Альвостаз / Альвожель", category: "surgery", unit: "шт.", quantity: 1, unitCostRub: 310 },
			{ name: "Анестетик артикаиновый 4% с эпинефрином 1:100000 1.7 мл", category: "anesthesia", unit: "карп.", quantity: 1, unitCostRub: 220 },
	...
	// ── 5. K04.5 ХРОНИЧЕСКИЙ АПИКАЛЬНЫЙ ПЕРИОДОНТИТ ──
	{
		...
		title: "Периодонтит (K04.5) — Распломбировка + NaOCl + Calcept Ca(OH)2",
		...
		treatmentDescription: "Инфильтрационная/проводниковая анестезия (Артикаин 4% 1.7 мл). Распломбирование корневых каналов, ревизия, прохождение до физиологического апекса под контролем апекслокатора. Обильная медикаментозная дезинфекция (NaOCl 3%, 2% хлоргексидин, ЭДТА, ультразвук). Временная обтурация каналов гидроксидом кальция Calcept для подавления инфекции и стимуляции остеогенеза. Герметичная временная пломба (Cavit / СИЦ). Контрольный осмотр через 10-14 дней.",
		anesthetic: { drugKey: "ultracain_ds_forte", drugName: "Ультракаин Д-С Форте 1:100 000", carpulesCount: 1.0, volumeMl: 1.7 },
		...
		recommendations: "Не накусывать на зуб твердую пищу. При болях — прием НПВП. При выпадении временной пломбы срочно обратиться в клинику.",
	},

	// ── 6. Z01.2 ПРОФГИГИЕНА И ОСМОТР ──
	{
		id: "hygiene_complex",
		title: "Комплексная профгигиена (Z01.2) — УЗ-скейлинг + Air-Flow + Clinpro",
		shortBadge: "Здоров",
		category: "hygiene",
		icd10: "Z01.2",
		...
		materialsToDeduct: [
			...
			{ name: "Полировочная паста Cleanic", category: "hygiene", unit: "г", quantity: 3, unitCostRub: 40 },
	...
	// ── 15. K02.1 + Z01.2 КОМПЛЕКСНЫЙ ПРИЕМ: ПРОФГИГИЕНА + КАРИЕС ──
	{
		...
		treatmentDescription: "1) Профессиональная гигиена: Ультразвуковой скейлинг (ultrasonic scaling) + обработка Air-Flow (порошок глицина) + полировка Cleanic + глубокое фторирование Clinpro White Varnish.\n\n2) Терапевтическое лечение кариеса: Инфильтрационная анестезия (Артикаин 4% 1.7 мл). Препарирование кариозной полости, некрэктомия. Коффердам. Антисептическая обработка 2% хлоргексидином. Адгезивный протокол OptiBond FL + послойная реставрация нанокомпозитом Estelite Sigma Quick с восстановлением окклюзионной анатомии. Шлифовка, полировка до сухого зеркального блеска.\n\nГарантийные обязательства: Гарантийный срок на световую композитную реставрацию — 24 мес. (срок службы: 36 мес.).",
		anesthetic: { drugKey: "ultracain_ds_forte", drugName: "Ультракаин Д-С Форте 1:100 000", carpulesCount: 1.0, volumeMl: 1.7 },
