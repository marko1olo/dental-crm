...
export function VisitMainTabs({
	...
	return (
		<div
			className="visit-sub-nav-tabs flex items-center gap-1.5 min-h-[44px] sm:h-9 overflow-x-auto whitespace-nowrap scrollbar-none w-full max-w-full px-2 shrink-0 overscroll-x-contain"
			role="tablist"
