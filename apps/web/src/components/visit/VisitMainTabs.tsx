...
export function VisitMainTabs({
	...
	return (
		<div
			ref={containerRef}
			className="visit-sub-nav-tabs flex items-center gap-1 sm:gap-2 min-h-[44px] sm:min-h-[32px] sm:h-8 h-11 sm:h-8 overflow-x-auto whitespace-nowrap scrollbar-none w-full max-w-full pl-1.5 pr-2 sm:pr-3 shrink-0 overscroll-x-contain py-0.5"
			style={{
