...
export const CLINICAL_PRESETS: ClinicalQuickPreset[] = [
	// ── ТЕРАПИЯ
	{
		...
		treatmentDescription:
			"Анестезия (Артикаин 4% 1:200 000 1.7 мл). Препарирование кариозной полости, осторожная некрэктомия. Изоляция коффердамом. Антисептическая обработка 2% хлоргексидином. Лечебная прокладка Ca(OH)2 точечно на дно, изолирующая прокладка СИЦ. Адгезивный протокол, послойная реставрация нанокомпозитом светового отверждения с восстановлением окклюзионной анатомии. Шлифовка, полировка.",
	},
	{
		id: "pulpitis_acute",
		...
		statusLocalis:
			"Глубокая кариозная полость, сообщающаяся с полостью зуба. Зондирование вскрытой точки рога пульпы резко болезненно, с кровоточивостью. Перкуссия безболезненна. ЭОД — 35-45 мкА.",
		treatmentDescription:
			"Проводниковая/инфильтрационная анестезия (Артикаин 4% 1.7 мл). Раскрытие полости зуба, создание прямого эндодонтического доступа. Коффердам. Витальная экстирпация пульпы. Определение рабочей длины (апекслокатор + визиография). Инструментальная обработка NiTi ProTaper с ирригацией NaOCl 3% и ЭДТА 17% с УЗ-активацией. Высушивание бумажными штифтами. Трехмерная обтурация каналов гуттаперчей с эпоксидным силером методом латеральной конденсации. Рентген-контроль. Восстановление коронки.",
	},
	{
		...
		treatmentDescription:
			"Анестезия. Распломбирование корневых каналов, прохождение до физиологического апекса. Обильная медикаментозная дезинфекция (NaOCl 3%, ЭДТА, ультразвук). Временная обтурация каналов гидроксидом кальция Ca(OH)2 для стимуляции остеогенеза и подавления инфекции. Герметичная временная пломба. Контрольный осмотр через 14 дней.",
	},
	...
	// ── ХИРУРГИЯ
	{
		...
		treatmentDescription:
			"Проводниковая мандибулярная/торусальная анестезия (Артикаин 4% 1:100 000 1.7 мл). Выкраивание углового слизисто-надкостничного лоскута. Создание костного доступа с охлаждением физраствором. Секционирование коронки и корней бором. Атравматичное извлечение фрагментов элеватором. Кюретаж лунки, ревизия нижнечелюстного канала. Гемостаз (Альвостаз / гемостатическая губка). Ушивание раны узловыми швами (Викрил 4-0). Рекомендации: лед, антибиотикотерапия, НПВС, осмотр через 48 часов.",
	},
	{
	...
	{
		id: "hygiene_complex",
		title: "Комплексная профгигиена (УЗ + Air-Flow)",
		shortBadge: "Профгигиена (Air-Flow)",
		category: "hygiene",
		icd10: "K05.0",
		icd10Label: "Острый гингивит / отложения",
		anamnesis:
			"Жалобы на наличие пигментированного зубного налета, кровоточивость десен при чистке зубов, неприятный запах изо рта.",
		statusLocalis:
		...
		treatmentDescription:
			"Аппликационная анестезия десны. Ультразвуковое удаление над- и поддесневого зубного камня скейлером с водяным охлаждением. Снятие плотного пигментированного налета порошкоструйным аппаратом Air-Flow (порошок глицина/эритритола). Полировка поверхностей зубов абразивной пастой и резиновыми головками, межзубные контакты обработаны штрипсами. Антисептическая обработка хлоргексидином 0.05%, аппликация фторсодержащего лака. Обучение гигиене.",
	},
];
