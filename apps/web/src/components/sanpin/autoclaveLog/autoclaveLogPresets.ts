...
export const STATUTORY_PACKAGING_TYPES: readonly PackagingTypeDefinition[] = [
	{
		...
		shelfLifeDays: 50,
		shelfLifeDescriptionRu: "До 50 суток в закрытых шкафах (при ширине термошва не менее 8 мм)",
	...
	},
	{
		...
		shelfLifeDays: 20,
		shelfLifeDescriptionRu: "До 20-30 суток (в зависимости от плотности бумаги и влажности)",
	...
	},
	{
		...
		shelfLifeDays: 21,
		shelfLifeDescriptionRu: "До 21 суток в двойной упаковке",
