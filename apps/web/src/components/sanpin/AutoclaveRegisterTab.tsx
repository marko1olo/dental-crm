...
export const DEFAULT_STERILIZATION_DEMO_RECORDS: SterilizationLogRecord[] = [
	{
		...
		notes: "СанПиН 3.3686-21. Все 5 точек КТ изменили цвет на эталон. [ЭЦП: Оператор ЦСО]",
	...
	},
	{
		...
		operatorId: null,
		operatorName: "Оператор ЦСО",
		notes: "Интеграторы 5 класса норма. Вакуум-тест пройден. [ЭЦП: Оператор ЦСО]",
	...
	},
	{
		...
		operatorId: null,
		operatorName: "Оператор ЦСО",
		notes: "Пакет герметичен. 50 суток хранения в сухом шкафу. [ЭЦП: Оператор ЦСО]",
	...
	},
	{
		...
		notes: "Предварительная продувка спреем проведена. Контроль стерильности 100%. [ЭЦП: Старшая медсестра]",
	...
	},
	{
		...
		operatorId: null,
		operatorName: "Оператор ЦСО",
		notes: "Все 5 контрольных точек камеры перешли в темно-коричневый цвет. [ЭЦП: Оператор ЦСО]",
