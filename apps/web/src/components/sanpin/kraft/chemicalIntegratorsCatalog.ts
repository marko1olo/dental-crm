...
export const CHEMICAL_INTEGRATORS_CATALOG: readonly ChemicalIntegratorDefinition[] = [
	...
	// ─────────────────────────────────────────────────────────────────────────
	{
		...
		code: "ИТ-134-5",
		nameRu: "ИнтеТЕСТ-В 134/5 (Класс 5)",
		shortLabelRu: "ИнтеТЕСТ-В 134/5 (Кл. 5 Интегратор, Винар)",
		brandRu: "ИнтеТЕСТ-В",
		manufacturerRu: "НПФ «Винар», Россия",
		classType: "class_5",
	...
	{
		id: "vinar_intetest_5_132_20",
		code: "ИТ-132-20",
		nameRu: "ИнтеТЕСТ-В 132/20 (Класс 5)",
		shortLabelRu: "ИнтеТЕСТ-В 132/20 (Кл. 5 Интегратор, Винар)",
		brandRu: "ИнтеТЕСТ-В",
		manufacturerRu: "НПФ «Винар», Россия",
		classType: "class_5",
		classLabelRu: "Класс 5 (Интегрирующий индикатор)",
		classDescriptionRu: "Интегрирует все параметры паровой стерилизации (132°C, пар, 20 мин, 2.0 бар). Соответствует споровому уровню стерильности по СанПиН 3.3686-21.",
		regimeId: "steam_132_20min",
		regimeLabelRu: "Пар 132°C / 20 мин / 2.0 бар (Интегратор SV)",
		targetTemperatureCelsius: 132,
		targetPressureBar: 2.0,
		targetExposureMinutes: 20,
		initialColorHex: "#cbd5e1",
		initialColorNameRu: "Светло-бежевый / серый",
		targetColorHex: "#0f172a",
		targetColorNameRu: "Глубокий сине-черный эталон",
		failColorHex: "#64748b",
		failColorNameRu: "Серый / сиреневый (сбой интеграции)",
		placementLocationRu: "Внутри каждого крафт-пакета и в 5 контрольных точках камеры автоклава (КТ-1..5)",
		interpretationRuleRu: "Срабатывает только при 100% проникновении сухого насыщенного пара и выдержке 132°C не менее 20 минут.",
		sanpinNormClauseRu: "СанПиН 3.3686-21 Таблица 3.12, ГОСТ ISO 11140-1 Класс 5",
		gostStandardRu: "ГОСТ ISO 11140-1 (Класс 5 Интегратор)",
		isCriticalSurgeryRecommended: true,
	},
	{
