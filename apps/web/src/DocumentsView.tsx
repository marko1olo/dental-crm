...
import { PaidMedicalServicesContractForm, CompletedWorksActForm, TreatmentCostEstimateForm, PaymentInvoiceForm, PaymentReceiptForm, InstallmentPaymentScheduleForm, MinorLegalRepresentativeConsentForm, WarrantyServiceMemoForm, PatientIntakeQuestionnaireForm, TreatmentPlanForm, TreatmentPlanAcceptanceForm, PostVisitRecommendationsForm, PrescriptionMedicationOrderForm, LabWorkOrderForm, XrayCbctReferralForm, OutpatientMedicalCard025uForm, MedicalRecordExtractForm, MedicalRecordCopyRequestForm, VisitAttendanceCertificateForm, MedicalDocumentReleaseReceiptForm, PaymentRefundCorrectionRequestForm } from "./DocumentsInlineForms";
			...
			>
				...
				>
					...
					{selectedDocumentKind === "treatment_plan_acceptance" ? (
						<TreatmentPlanAcceptanceForm {...props} />
					) : null}

					{selectedDocumentKind === "post_visit_recommendations" ? (
						<PostVisitRecommendationsForm {...props} />
					) : null}
					...
					{selectedDocumentKind === "prescription_medication_order" ? (
						<PrescriptionMedicationOrderForm {...props} />
					) : null}

					{selectedDocumentKind === "lab_work_order" ? (
						<LabWorkOrderForm {...props} />
					) : null}
					...
					{selectedDocumentKind === "payment_refund_correction_request" ? (
						<PaymentRefundCorrectionRequestForm {...props} />
					) : null}
				</section>
