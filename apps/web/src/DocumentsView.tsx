				...
				>
					...
					{selectedDocumentKind === "treatment_plan" ? (
						<TreatmentPlanDocumentForm
							activeDoctorFullName={activeDoctor?.fullName}
							activeVisitComplaint={dashboard?.activeVisit?.complaint}
							activeVisitDiagnosis={dashboard?.activeVisit?.diagnosis}
							inferredTreatmentArea={inferredTreatmentArea}
					...
					{selectedDocumentKind === "medical_record_extract" ? (
						<MedicalCardExtract003vuForm
							initialPayload={{
								attendingDoctorFullName: activeDoctor?.fullName ?? undefined,
								primaryDiagnosisText: dashboard?.activeVisit?.diagnosis ?? undefined,
								initialConsultationDiagnosis: dashboard?.activeVisit?.diagnosis ?? undefined,
