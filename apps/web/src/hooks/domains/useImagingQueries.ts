...
export function useImagingQueries() {
  ...
  const analyzeVisiograph = async (payload: { patientId: string; imageBase64: string; focus?: "caries" | "perio" | "endo" | null }) => {
  ...
  return { getScans, saveBatchToothStates, analyzeVisiograph, saveScan, getScan, deleteScan };
}
