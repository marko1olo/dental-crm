...
export const dicomDiagnosticPixelPolicyLabels: Record<string, string> = {
	...
	desktop_app_or_external_review:
		"настольный или внешний диагностический просмотр",
};
...
export const mprResourceTierLabels: Record<
	DicomMprResourcePolicy["requiredTier"],
	string
> = {
	low_end: "слабый ПК",
	standard: "обычный ПК",
...
export const mprLoadStrategyLabels: Record<
	DicomMprResourcePolicy["loadStrategy"],
	string
> = {
	metadata_only: "только метаданные",
...
export const mprCacheModeLabels: Record<
	DicomMprResourcePolicy["cacheMode"],
	string
> = {
...
export const localImagingOrganizerActionLabels: Record<
	LocalImagingOrganizerRecommendedAction,
	string
> = {
...
export const dicomWebStatusLabels: Record<
	DicomWebConnectorCheckResponse["status"],
	string
> = {
	ready: "готово",
...
export const dicomViewerLaunchModeLabels: Record<
	DicomViewerLaunchManifestResponse["launchMode"],
	string
> = {
...
export const dicomReadinessCheckLabels: Record<
	DicomWorkstationReadinessResponse["checks"][number]["status"],
	string
> = {
	pass: "Готово",
	warn: "Проверить",
