...
import { ExternalLink, FlipHorizontal, ImageIcon, Plus, RefreshCw, RotateCcw, RotateCw, ZoomIn, ZoomOut } from "lucide-react";
export interface ImagingViewProps {
  CtPlanningToolsPanel: any;
  ExternalLink: any;
  FlipHorizontal: any;
  ImageIcon: any;
  Plus: any;
  ...
  activePatient: any;
  addImagingViewerNoteAnnotation: any;
  applyCtPlanningQuickAction: any;
  applyMprClinicalPreset: any;
  applyNearestMprClinicalPreset: any;
  canRetryImagingViewerSave: any;
  cbctWorkbenchPlanes: any;
  cbctWorkbenchProjections: any;
  cbctWorkbenchSeries: any;
  clampMprAxisDeg: any;
  clampMprSlabMm: any;
  clampMprSliceIndex: any;
  createCtPlanningArtifact: any;
  createImagingStudy: any;
  ctPlanningActiveQuickActionId: any;
  ctPlanningAnnotationRefs: any;
  ctPlanningImplantPlan: any;
  currentView: any;
  defaultImagingViewerState: any;
  ...
  formatShortDate: any;
  formatSignedMprStep: any;
  formatTime: any;
  handleMprKeyboardNavigation: any;
  imagingComparisonCandidates: any;
  imagingCreateSavingKind: any;
  imagingKindFilter: any;
  imagingKindLabels: any;
  imagingKindOptions: any;
  imagingPreviewSource: any;
  imagingSourceLabels: any;
  imagingViewerActiveTool: any;
  imagingViewerAnnotations: any;
  imagingViewerHref: any;
  imagingViewerImageStyle: any;
  imagingViewerNote: any;
  imagingViewerNoteMissingId: any;
  imagingViewerNoteReady: any;
  imagingViewerRetryMissingId: any;
  imagingViewerSaveDetail: any;
  imagingViewerSaveState: any;
  imagingViewerSaveTitle: any;
  imagingViewerSessionReady: any;
  imagingViewerState: any;
  imagingViewerToolLabels: any;
  isOnline: any;
  mprActiveProjectionLabel: any;
  mprActiveProjectionOrientation: any;
  mprAxisAngleBadge: any;
  mprAxisBounds: any;
  mprAxisDeg: any;
  mprAxisDirectionLabel: any;
  mprAxisGuidance: any;
  mprAxisNudgeDeg: any;
  mprAxisPresetDeg: any;
  mprAxisRangeValue: any;
  mprAxisVisualizerLabel: any;
  mprAxisVisualizerStyle: any;
  mprClinicalChecklist: any;
  mprClinicalNextStep: any;
  mprClinicalPresetButtonClass: any;
  mprClinicalPresets: any;
  mprControlsAutoOpen: any;
  mprControlsReady: any;
  ...
  mprProjectionLabels: any;
  mprSafeSliceIndex: any;
  mprSeriesRequiredProjectionLabel: any;
  mprSlabBadge: any;
  mprSlabBounds: any;
  mprSlabMm: any;
  mprSlabNudgeMm: any;
  mprSlabPresetMm: any;
  mprSlabRangeValue: any;
  mprSliceBadge: any;
  mprSliceIndexFromFraction: any;
  mprSliceLabel: any;
  mprSliceMaxIndex: any;
  mprSliceNudgeSteps: any;
  mprSlicePresetFractions: any;
  mprSliceRangeValue: any;
  mprUnavailableProjectionLabel: any;
  mprWindowPreset: any;
  mprWindowPresetLabels: any;
  mprWorkbenchDraftRestored: any;
  mprWorkbenchLocalSavedAt: any;
  mprWorkbenchSummaryText: any;
  resetMprControls: any;
  restoreMprWorkbenchLocalDraft: any;
  retryImagingViewerSessionSave: any;
  selectCtPlanningImplant: any;
  selectedImagingStudy: any;
  selectedImagingViewerPlan: any;
  setCtPlanningActiveQuickActionId: any;
  setCtPlanningImplantPlan: any;
  setImagingKindFilter: any;
  setImagingViewerActiveTool: any;
  setImagingViewerNote: any;
  setImagingViewerState: any;
  setMprAxisDeg: any;
  setMprCrosshairEnabled: any;
  setMprLinkedPlanesEnabled: any;
  setMprProjection: any;
  setMprSlabMm: any;
  setMprSliceIndex: any;
  setMprWindowPreset: any;
  setSelectedImagingStudyId: any;
  visibleImagingStudies: any;
}

export function ImagingView(props: ImagingViewProps) {
  const { CtPlanningToolsPanel, ExternalLink, FlipHorizontal, ImageIcon, Plus, RefreshCw, RotateCcw, RotateCw, ZoomIn, ZoomOut, activeAppointment, activeImagingStudies, activePatient, addImagingViewerNoteAnnotation, applyCtPlanningQuickAction, applyMprClinicalPreset, applyNearestMprClinicalPreset, canRetryImagingViewerSave, cbctWorkbenchPlanes, cbctWorkbenchProjections, cbctWorkbenchSeries, clampMprAxisDeg, clampMprSlabMm, clampMprSliceIndex, createCtPlanningArtifact, createImagingStudy, ctPlanningActiveQuickActionId, ctPlanningAnnotationRefs, ctPlanningImplantPlan, currentView, defaultImagingViewerState, describeMprClinicalPresetProjectionFallback, dicomLabel, dicomQualityModeLabels, dicomTextureStrategyLabels, dicomViewerToolStateBundle, dicomViewerWorkbenchManifest, formatShortDate, formatSignedMprStep, formatTime, handleMprKeyboardNavigation, imagingComparisonCandidates, imagingCreateSavingKind, imagingKindFilter, imagingKindLabels, imagingKindOptions, imagingPreviewSource, imagingSourceLabels, imagingViewerActiveTool, imagingViewerAnnotations, imagingViewerHref, imagingViewerImageStyle, imagingViewerNote, imagingViewerNoteMissingId, imagingViewerNoteReady, imagingViewerRetryMissingId, imagingViewerSaveDetail, imagingViewerSaveState, imagingViewerSaveTitle, imagingViewerSessionReady, imagingViewerState, imagingViewerToolLabels, isOnline, mprActiveProjectionLabel, mprActiveProjectionOrientation, mprAxisAngleBadge, mprAxisBounds, mprAxisDeg, mprAxisDirectionLabel, mprAxisGuidance, mprAxisNudgeDeg, mprAxisPresetDeg, mprAxisRangeValue, mprAxisVisualizerLabel, mprAxisVisualizerStyle, mprClinicalChecklist, mprClinicalNextStep, mprClinicalPresetButtonClass, mprClinicalPresets, mprControlsAutoOpen, mprControlsReady, mprCrosshairEnabled, mprLinkedPlanesEnabled, mprNearestClinicalPreset, mprOperatorSummaryCards, mprProjection, mprProjectionCompass, mprProjectionLabels, mprSafeSliceIndex, mprSeriesRequiredProjectionLabel, mprSlabBadge, mprSlabBounds, mprSlabMm, mprSlabNudgeMm, mprSlabPresetMm, mprSlabRangeValue, mprSliceBadge, mprSliceIndexFromFraction, mprSliceLabel, mprSliceMaxIndex, mprSliceNudgeSteps, mprSlicePresetFractions, mprSliceRangeValue, mprUnavailableProjectionLabel, mprWindowPreset, mprWindowPresetLabels, mprWorkbenchDraftRestored, mprWorkbenchLocalSavedAt, mprWorkbenchSummaryText, resetMprControls, restoreMprWorkbenchLocalDraft, retryImagingViewerSessionSave, selectCtPlanningImplant, selectedImagingStudy, selectedImagingViewerPlan, setCtPlanningActiveQuickActionId, setCtPlanningImplantPlan, setImagingKindFilter, setImagingViewerActiveTool, setImagingViewerNote, setImagingViewerState, setMprAxisDeg, setMprCrosshairEnabled, setMprLinkedPlanesEnabled, setMprProjection, setMprSlabMm, setMprSliceIndex, setMprWindowPreset, setSelectedImagingStudyId, visibleImagingStudies } = props;
  const { CtPlanningToolsPanel, ExternalLink, FlipHorizontal, ImageIcon, Plus, RefreshCw, RotateCcw, RotateCw, ZoomIn, ZoomOut, activeAppointment, activeImagingStudies, activePatient, addImagingViewerNoteAnnotation, applyCtPlanningQuickAction, applyMprClinicalPreset, applyNearestMprClinicalPreset, canRetryImagingViewerSave, cbctWorkbenchPlanes, cbctWorkbenchProjections, cbctWorkbenchSeries, clampMprAxisDeg, clampMprSlabMm, clampMprSliceIndex, createCtPlanningArtifact, createImagingStudy, ctPlanningActiveQuickActionId, ctPlanningAnnotationRefs, ctPlanningImplantPlan, currentView, defaultImagingViewerState, describeMprClinicalPresetProjectionFallback, dicomLabel, dicomQualityModeLabels, dicomTextureStrategyLabels, dicomViewerToolStateBundle, dicomViewerWorkbenchManifest, formatShortDate, formatSignedMprStep, formatTime, handleMprKeyboardNavigation, imagingComparisonCandidates, imagingCreateSavingKind, imagingKindFilter, imagingKindLabels, imagingKindOptions, imagingPreviewSource, imagingSourceLabels, imagingViewerActiveTool, imagingViewerAnnotations, imagingViewerHref, imagingViewerImageStyle, imagingViewerNote, imagingViewerNoteMissingId, imagingViewerNoteReady, imagingViewerRetryMissingId, imagingViewerSaveDetail, imagingViewerSaveState, imagingViewerSaveTitle, imagingViewerSessionReady, imagingViewerState, imagingViewerToolLabels, isOnline, mprActiveProjectionLabel, mprActiveProjectionOrientation, mprAxisAngleBadge, mprAxisBounds, mprAxisDeg, mprAxisDirectionLabel, mprAxisGuidance, mprAxisNudgeDeg, mprAxisPresetDeg, mprAxisRangeValue, mprAxisVisualizerLabel, mprAxisVisualizerStyle, mprClinicalChecklist, mprClinicalNextStep, mprClinicalPresetButtonClass, mprClinicalPresets, mprControlsAutoOpen, mprControlsReady, mprCrosshairEnabled, mprLinkedPlanesEnabled, mprNearestClinicalPreset, mprOperatorSummaryCards, mprProjection, mprProjectionCompass, mprProjectionLabels, mprSafeSliceIndex, mprSeriesRequiredProjectionLabel, mprSlabBadge, mprSlabBounds, mprSlabMm, mprSlabNudgeMm, mprSlabPresetMm, mprSlabRangeValue, mprSliceBadge, mprSliceIndexFromFraction, mprSliceLabel, mprSliceMaxIndex, mprSliceNudgeSteps, mprSlicePresetFractions, mprSliceRangeValue, mprUnavailableProjectionLabel, mprWindowPreset, mprWindowPresetLabels, mprWorkbenchDraftRestored, mprWorkbenchLocalSavedAt, mprWorkbenchSummaryText, resetMprControls, restoreMprWorkbenchLocalDraft, retryImagingViewerSessionSave, selectCtPlanningImplant, selectedImagingStudy, selectedImagingViewerPlan, selectedWorkspaceRole, setCtPlanningActiveQuickActionId, setCtPlanningImplantPlan, setImagingKindFilter, setImagingViewerActiveTool, setImagingViewerNote, setImagingViewerState, setMprAxisDeg, setMprCrosshairEnabled, setMprLinkedPlanesEnabled, setMprProjection, setMprSlabMm, setMprSliceIndex, setMprWindowPreset, setSelectedImagingStudyId, visibleImagingStudies } = props;
  return <>
        {currentView === "imaging" ? (
