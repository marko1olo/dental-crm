...
export function InvoiceSplitPaymentModal({
	invoiceId,
	totalAmount,
	patientId,
	onClose,
	...
	const { splitPayments, addSplitPayment, removeSplitPayment } =
		useBillingStore();
	const [method, setMethod] = useState<
		"cash" | "card" | "dms" | "family_wallet"
	>("card");
	...
	const handleAdd = () => {
		if (amount > 0 && amount <= remaining) {
			...
			if (method === "family_wallet" && familyGroupId)
				paymentData.familyGroupId = familyGroupId;
