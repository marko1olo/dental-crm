...
export const PERIO_PATHOLOGY_PRESETS: readonly PerioPathologyPreset[] = [
	{
		...
		defaultIcd10: "K05.1",
		statusLocalis:
			"Десна в области альвеолярного отростка гиперемирована, отечна, цианотична, кровоточит при зондировании (BOP+). Зубодесневое прикрепление сохранено, патологических карманов нет. Мягкий зубной налет, наддесневые зубные отложения.",
		treatmentDescription:
			"Профессиональная гигиена полости рта (ультразвук + Air-Flow). Антисептическая обработка (хлоргексидин 0.05%). Аппликация противовоспалительного геля (Метрогил Дента). Обучение гигиене.",
	},
	{
