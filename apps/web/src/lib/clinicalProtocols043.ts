...
export const PERIO_PATHOLOGY_PRESETS: readonly PerioPathologyPreset[] = [
	{
		...
		defaultIcd10: "Z01.2",
		statusLocalis:
			"Десна бледно-розовая, плотная, плотно охватывает шейки зубов. Зубодесневое прикрепление сохранено на всем протяжении. Глубина десневой бороздки в пределах физиологической нормы 1.0–2.0 мм. Кровоточивость при зондировании отсутствует (BOP 0%). Патологическая подвижность зубов отсутствует (0 ст.). Зубные отложения не определяются.",
		treatmentDescription:
