...
export const telegramDocumentRequestTaskDocumentKinds: Record<
	string,
...
export const telegramCareRequestTaskCareTopics: Record<
	string,
	PostVisitCareTopic
> = {
...
export const telegramDocumentRequestWorkflowDocumentKinds: Partial<
	Record<
		NonNullable<CommunicationTaskWorkflowCode>,
		readonly GeneratedDocument["kind"][]
	>
> = {
...
export const telegramCareRequestWorkflowCareTopics: Partial<
	Record<NonNullable<CommunicationTaskWorkflowCode>, PostVisitCareTopic>
> = {
...
export const communicationDocumentTaskActionLabels: Partial<
