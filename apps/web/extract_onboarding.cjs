...
fs.mkdirSync('C:/Clinic_MVP/dental-crm/apps/web/src/components/onboarding', { recursive: true });
fs.writeFileSync('C:/Clinic_MVP/dental-crm/apps/web/src/components/onboarding/OnboardingWizard.tsx', newComponent);

lines.splice(startIdx, endIdx - startIdx + 1, '      <OnboardingWizard />');
lines.splice(55, 0, 'import { OnboardingWizard } from "./components/onboarding/OnboardingWizard";');
