...
export async function findDuplicateCandidates(
	...
	return {
		...
		note:
			"Совпадение телефона само по себе дублем не является: родственники записаны на один номер. " +
			"Одинаковое имя при разных датах рождения — это разные люди, такие пары не предлагаются."
	};
}
