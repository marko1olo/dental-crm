 ...
 *      ФИО строкой (db/patientCommunicationTimelinesQuery.ts:40). Появись у
 *      таблицы писатель — два тёзки получили бы общую переписку, а смена фамилии
 *      после свадьбы оторвала бы всю историю от карточки.
 *
 ...
 * SQL тестом (tests/services/patientCommunicationLog.test.ts), а не глазами.
 *
