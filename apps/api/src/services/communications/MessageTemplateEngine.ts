...
export const CLINICAL_SECRECY_PATTERNS: readonly { pattern: RegExp; description: string }[] = [
	...
	{ pattern: /(?<![а-яёА-ЯЁ])пульпит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Пульпит" },
	{ pattern: /(?<![а-яёА-ЯЁ])кариес[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Кариес" },
	{ pattern: /(?<![а-яёА-ЯЁ])периодонтит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Периодонтит" },
	{ pattern: /(?<![а-яёА-ЯЁ])пародонтит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Пародонтит" },
	{ pattern: /(?<![а-яёА-ЯЁ])гингивит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Гингивит" },
	{ pattern: /(?<![а-яёА-ЯЁ])альвеолит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Альвеолит" },
	{ pattern: /(?<![а-яёА-ЯЁ])остеомиелит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Остеомиелит" },
	{ pattern: /(?<![а-яёА-ЯЁ])стоматит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Стоматит" },
	{ pattern: /(?<![а-яёА-ЯЁ])перикоронит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Перикоронит" },
	{ pattern: /(?<![а-яёА-ЯЁ])гранул[её]м[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Гранулема" },
	{ pattern: /(?<![а-яёА-ЯЁ])периимплантит[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Диагноз: Периимплантит" },
	{ pattern: /(?<![а-яёА-ЯЁ])депульпировани[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Медицинское вмешательство: Депульпирование" },
	{ pattern: /(?<![а-яёА-ЯЁ])экстирпаци[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Медицинское вмешательство: Экстирпация пульпы" },
	{ pattern: /(?<![а-яёА-ЯЁ])препарировани[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Медицинское вмешательство: Препарирование" },
	{ pattern: /(?<![а-яёА-ЯЁ])удалени[а-яёА-ЯЁ]*\s+нерв[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Клиническая процедура: Удаление нерва (депульпирование)" },
	{ pattern: /(?<![а-яёА-ЯЁ])синус-лифтинг[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Хирургическая операция: Синус-лифтинг" },
	{ pattern: /(?<![а-яёА-ЯЁ])остеотоми[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Хирургическая операция: Остеотомия" },
	{ pattern: /(?<![а-яёА-ЯЁ])кюретаж[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Пародонтологическое вмешательство: Кюретаж" },
	{ pattern: /(?<![а-яёА-ЯЁ])резекци[а-яёА-ЯЁ]*\s+верхушк[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi, description: "Хирургическая операция: Резекция верхушки корня" },
	{
		pattern: /(?<![а-яёА-ЯЁ])(?:зуб[а-яёА-ЯЁ]*)\s*(?:№\s*)?(?:[1-4][1-8]|[5-8][1-5]|\d{1,2})(?![а-яёА-ЯЁ])/gi,
		description: "Клиническая локализация: указание номера зуба",
	},
	{
		pattern: /(?<![а-яёА-ЯЁ])(?:полост[а-яёА-ЯЁ]*)\s*(?:I{1,3}|IV|V|VI)\s*класс[а-яёА-ЯЁ]*(?![а-яёА-ЯЁ])/gi,
		description: "Клиническое описание кариозной полости по Блэку",
	},
	{
		pattern: /(?<![а-яёА-ЯЁ])класс[а-яёА-ЯЁ]*\s*(?:по\s*Блэку|по\s*Black)(?![а-яёА-ЯЁ])/gi,
		description: "Классификация кариозной полости по Блэку",
	},
	{
		pattern: /(?<![а-яёА-ЯЁ])(?:ВИЧ|ВИЧ-инфекци[а-яёА-ЯЁ]*|гепатит[а-яёА-ЯЁ]*|туберкул[её]з[а-яёА-ЯЁ]*|сифилис[а-яёА-ЯЁ]*|онкологи[а-яёА-ЯЁ]*|злокачественн[а-яёА-ЯЁ]*|сахарн[а-яёА-ЯЁ]*\s*диабет[а-яёА-ЯЁ]*)(?![а-яёА-ЯЁ])/gi,
