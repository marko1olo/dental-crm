...
const ROLE_PERMISSIONS: Record<string, readonly Permission[]> = {
	...
	// Врач: ведёт приём, оформляет и принимает оплату у кресла (Мандат 8e / 8n соло-врач),
	// списывает расходные материалы приёма.
	doctor: [
		"schedule.read",
		"schedule.write",
		"patients.read",
 ...
 *     владелец, admin, управляющий, администратор ресепшена, врач (Мандаты 8e/8n: соло-врач).
 ...
 * не имеет права (ассистент у кассы, ассистент в настройках) — это ловит реальные
