...
function mapClinicalRule(record: typeof schema.clinicalRules.$inferSelect): ClinicalRule {
  return {
    ...
    title: record.title,
    category: record.category as ClinicalRule["category"],
    specialty: record.specialty as ClinicalRule["specialty"],
    action: record.action as ClinicalRule["action"],
    severity: record.severity as ClinicalRule["severity"],
    ownerRole: record.ownerRole as ClinicalRule["ownerRole"],
