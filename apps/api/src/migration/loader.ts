 ...
 */
export function migrationTimeZoneFrom(
	clinicZone: string | null | undefined,
): MigrationTimeZone {
 ...
 */
export function transferredMoment(
	parsed: Date | null | undefined,
): TransferredMoment {
 ...
 */
async function migrationTimeZone(
	organizationId: string,
	entityTitle: string,
): Promise<MigrationTimeZone> {
 ...
 */
function explainDatabaseError(error: unknown): {
	message: string;
	suggestedFix: string;
