...
import { registerEndodonticRoutes } from "./routes/endodontics.js";
import { registerOrthodonticRoutes } from "./routes/orthodontics.js";
...
export async function createDenteApiApp(
	...
	await registerOrthodonticRoutes(app);
	await registerPharmacologyRoutes(app);
	await registerEndodonticRoutes(app);
