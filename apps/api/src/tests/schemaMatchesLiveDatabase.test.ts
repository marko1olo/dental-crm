 ...
 * плана лечения и разметки КЛКТ); остальные 270 трогают объявления, по которым прямо
 ...
 *
 * Реестр держит ровно эти 270 и работает В ОБЕ СТОРОНЫ:
...
/**
 * САМОПРОВЕРКА РЕЕСТРА: он обязан остаться реестром 270 замеренных расхождений, а
 ...
 * поимённо.
 */
const REGISTERED_DIVERGENCE_COUNT = 270;
