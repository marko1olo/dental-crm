...
function stateCollectionCounts(
	state: Partial<DentalMutableState> | null | undefined,
...
function checksumVerified(
	payload: Partial<PersistedDentalState> | null | undefined,
): boolean | null {
...
function compactPersistenceWarnings(
...
function readPersistedPayload(filePath: string): {
	payload: Partial<PersistedDentalState> | null;
	error: PersistedPayloadReadError | null;
} {
	...
	try {
		return {
			...
			) as Partial<PersistedDentalState>,
			error: null,
		};
	} catch {
