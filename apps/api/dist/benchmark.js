...
async function runBenchmark() {
    ...
    console.log(`Max event loop block during sync read (timer delay): ${maxBlockSync.toFixed(2)}ms`);
    ...
    console.log(`Max event loop block during async read (timer delay): ${maxBlockAsync.toFixed(2)}ms`);
