...
import { patients, toothStateHistory, toothStates, treatmentPlanItemsNew, treatmentPlans, } from "../db/schema.js";
...
const fdiToothNumberSchema = z
    ...
    message: "Недопустимый номер зуба. Система FDI: 11–18, 21–28, 31–38, 41–48 (постоянные), 51–55, 61–65, 71–75, 81–85 (молочные).",
});
