                                                                                                            ...
                                                                                                            test('evaluates deliveryMethod "other" after DICOM checks', () => {
                                                                                                                ...
                                                                                                                describe('medicalRecordExtractPeriodIsChronological', () => {
                                                                                                                    ...
                                                                                                                    test('returns true when periodStart is before periodEnd', () => {
                                                                                                                        const payload = { ...basePayload, periodStart: '2023-01-01', periodEnd: '2023-12-31' };
                                                                                                                        ...
                                                                                                                        test('returns true when periodStart is same as periodEnd', () => {
                                                                                                                            const payload = { ...basePayload, periodStart: '2023-01-01', periodEnd: '2023-01-01' };
                                                                                                                            assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), true);
                                                                                                                            test('returns false when periodStart is after periodEnd', () => {
                                                                                                                                const payload = { ...basePayload, periodStart: '2023-12-31', periodEnd: '2023-01-01' };
                                                                                                                                assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), false);
                                                                                                                                test('returns true when periodStart is blank', () => {
                                                                                                                                    const payload = { ...basePayload, periodStart: '', periodEnd: '2023-12-31' };
                                                                                                                                    assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), true);
                                                                                                                                    test('returns true when periodEnd is blank', () => {
                                                                                                                                        const payload = { ...basePayload, periodStart: '2023-01-01', periodEnd: '' };
                                                                                                                                        assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), true);
                                                                                                                                        test('returns true when both periods are blank', () => {
                                                                                                                                            const payload = { ...basePayload, periodStart: '', periodEnd: '' };
                                                                                                                                            assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), true);
                                                                                                                                            test('returns false when periodStart is invalid format', () => {
                                                                                                                                                const payload = { ...basePayload, periodStart: 'invalid', periodEnd: '2023-12-31' };
                                                                                                                                                assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), false);
                                                                                                                                                test('returns false when periodEnd is invalid format', () => {
                                                                                                                                                    const payload = { ...basePayload, periodStart: '2023-01-01', periodEnd: 'invalid' };
                                                                                                                                                    assert.strictEqual(medicalRecordExtractPeriodIsChronological(payload), false);
                                                                                                                                                    test('returns dicom_archive when deliveryMethod is dicom_archive', () => {
                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('dicom_archive'), 'dicom_archive');
                                                                                                                                                        // Should return dicom_archive even if we pass types that would otherwise trigger "mixed"
                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('dicom_archive', ['dicom']), 'dicom_archive');
                                                                                                                                                        test('returns mixed when includeDicomSourceData is true', () => {
                                                                                                                                                            assert.strictEqual(releaseMaterialKindForDelivery('paper', [], true), 'mixed');
                                                                                                                                                            assert.strictEqual(releaseMaterialKindForDelivery('secure_link', ['some_doc'], true), 'mixed');
                                                                                                                                                            test('returns mixed when documentTypes contains dicom-related keywords', () => {
                                                                                                                                                                // English 'dicom'
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['DICOM image']), 'mixed');
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['X-Ray dicom file']), 'mixed');
                                                                                                                                                                // Russian 'кт'
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['КТ челюсти']), 'mixed');
                                                                                                                                                                // English 'cbct'
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['cbct scan']), 'mixed');
                                                                                                                                                                // Russian 'сним'
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['рентгеновский снимок']), 'mixed');
                                                                                                                                                                assert.strictEqual(releaseMaterialKindForDelivery('paper', ['Снимки зубов']), 'mixed');
                                                                                                                                                                test('returns other when deliveryMethod is other', () => {
                                                                                                                                                                    assert.strictEqual(releaseMaterialKindForDelivery('other'), 'other');
                                                                                                                                                                    test('returns copy by default for other delivery methods without dicom data', () => {
                                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('paper'), 'copy');
                                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('pdf'), 'copy');
                                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('physical_media'), 'copy');
                                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('secure_link'), 'copy');
                                                                                                                                                                        assert.strictEqual(releaseMaterialKindForDelivery('paper', ['contract', 'invoice']), 'copy');
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            test('generates different hashes for different scopes', () => {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                test('generates different hashes if documentId changes', () => {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    test('generates different hashes if kind changes', () => {
                                                                                                                                                                                                                        const hash1 = releaseSourceSnapshotSha256(baseDocument, 'test_scope');
                                                                                                                                                                                                                        const doc2 = { ...baseDocument, kind: 'medical_record_extract' };
                                                                                                                                                                                                                        const hash2 = releaseSourceSnapshotSha256(doc2, 'test_scope');
                                                                                                                                                                                                                        assert.notStrictEqual(hash1, hash2);
