...
export function formatLabOrderPrescriptionA4(
	...
	return [
		"================================================================================",
		"            НАРЯД-ЗАКАЗ В ЗУБОТЕХНИЧЕСКУЮ ЛАБОРАТОРИЮ (ФОРМА № ЗТЛ-1)           ",
		...
		"- Клиническая автономия (Мандат 8e п. 7): Истечение 30 дней плана лечения не блокирует",
		"  изготовление наряда ЗТЛ, оказание услуг или оплату.",
		"",
		"--------------------------------------------------------------------------------",
		"6. ПОДПИСИ СТОРОН",
		"--------------------------------------------------------------------------------",
