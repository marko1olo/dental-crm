 ...
 */
export const toothDefectTypeSchema = z.enum([
	"outpatient",
	"orthodontic",
	"anomaly",
]);
...
export const toothDefectKeySchema = z
	.enum([
		"require_treatment",
		"cured_teeth",
		"rg_klkt",
...
export const toothDefectColorSchema = z
	.enum(["red", "yellow", "green", "white", "orange", "blue", "gray"])
	.nullable();
...
export type ToothDefectCatalogItem = z.infer<
	typeof toothDefectCatalogItemSchema
>;
...
export type AssignPatientToothDefectInput = z.infer<
	typeof assignPatientToothDefectSchema
>;
...
export type UpdatePatientToothDefectInput = z.infer<
	typeof updatePatientToothDefectSchema
>;
...
export type OutpatientVerificationStatus = z.infer<
	typeof outpatientVerificationStatusSchema
>;
...
export type SubmitOutpatientForVerificationInput = z.infer<
	typeof submitOutpatientForVerificationSchema
>;
...
export type UpdateOutpatientVerificationStatusInput = z.infer<
	typeof updateOutpatientVerificationStatusSchema
>;
...
export function isOutpatientEditDeadlineExpired(
	...
	const deadline =
		typeof editableDeadline === "string"
			? new Date(editableDeadline)
			: editableDeadline;
...
export type OutpatientTemplatesFilter = z.infer<
	typeof outpatientTemplatesFilterSchema
>;
