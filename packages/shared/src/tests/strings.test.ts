...
describe("isValidRussianSnils", () => {
  ...
  test("returns true for numPart <= 1001001", () => {
    assert.strictEqual(isValidRussianSnils("00100100099"), true);
    assert.strictEqual(isValidRussianSnils("00000000100"), true);
  });

  test("returns true for valid computations", () => {
    assert.strictEqual(isValidRussianSnils("11223344595"), true); // sum < 100
    assert.strictEqual(isValidRussianSnils("12223344200"), true); // sum === 100
    assert.strictEqual(isValidRussianSnils("12223344300"), true); // sum === 101
    assert.strictEqual(isValidRussianSnils("12223344401"), true); // sum > 101, rem === 1
    assert.strictEqual(isValidRussianSnils("89710000200"), true); // sum > 101, rem === 100
    assert.strictEqual(isValidRussianSnils("89710000300"), true); // sum > 101, rem === 101
  });

  test("returns false for invalid computations", () => {
    assert.strictEqual(isValidRussianSnils("11223344596"), false);
    assert.strictEqual(isValidRussianSnils("12223344201"), false);
  });
