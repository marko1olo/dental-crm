...
export interface ThermalPrinterConfig {
	...
	readonly port: number; // e.g. 9100
	readonly protocol: ThermalPrinterProtocol; // zpl | tspl | escpos
...
export function calculateSanpinKraftLifespanDays(materialId: KraftPackageMaterialId): number {
