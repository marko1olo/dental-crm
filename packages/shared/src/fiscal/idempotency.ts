...
export type FinancialIdempotencyStatus =
	| "in_progress"
	| "completed"
	| "conflict"
	| "failed";
 ...
 */
export function parseFinancialIdempotencyKey(
	key: string,
): CompositeIdempotencyParseResult {
 ...
 */
export function generateFinancialCompositeIdempotencyKey(
	uuid: string,
	payload: unknown,
): string {
 ...
 */
export function verifyFinancialIdempotencyMatch(
	compositeKey: string,
	payload: unknown,
): {
