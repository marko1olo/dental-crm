...
export type DicomContrastPresetKey =
	| "bone"
	| "soft_tissue"
	| "enamel"
	| "nerve_sinus"
...
export const DICOM_CONTRAST_PRESETS: Record<DicomContrastPresetKey, DicomContrastPreset> = {
	bone: {
		id: "bone",
...
export const DICOM_CONTRAST_PRESET_LIST: readonly DicomContrastPreset[] = Object.values(
 ...
 */
export function huToGrayscale8Bit(
	hu: number,
	windowWidth: number,
	windowCenter: number,
	invert = false,
