 ...
 *
 * Канонический источник истины (SSOT) для API и Web (Мандат 8s).
 */
...
/**
 * Преобразует сумму в копейках в строку прописью с заглавной буквы.
 * Канонический алиас для kopecksToWordsRu (стандарт точных копеек DENTE).
 */
export const moneyToWordsRu = kopecksToWordsRu;
