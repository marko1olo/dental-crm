...
export function generateStatutoryConsent1051nPayload(params: {
	...
	let title: string = "ИНФОРМИРОВАННОЕ ДОБРОВОЛЬНОЕ СОГЛАСИЕ НА МЕДИЦИНСКОЕ ВМЕШАТЕЛЬСТВО (ПРИКАЗ МЗ РФ № 1051н)";
 ...
 */
export function renderInformedConsent1051nHtml(payload: InformedConsent1051nPayload | any): string {
