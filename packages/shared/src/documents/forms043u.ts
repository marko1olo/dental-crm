...
export const toothSurfaceLabels: Record<ToothSurface, string> = {
...
export const toothStatusCodeShortMap: Record<ToothClinicalStatusCode, string> = {
	healthy: "Norm",
	caries_initial: "C0",
...
export const toothStatusCodeLabels: Record<ToothClinicalStatusCode, string> = {
	healthy: "Здоровый (норма)",
...
export const dentalBiteTypeLabels: Record<DentalBiteType, string> = {
