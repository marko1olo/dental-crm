...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * ВЫПИСКА ИЗ МЕДИЦИНСКОЙ КАРТЫ СТОМАТОЛОГИЧЕСКОГО БОЛЬНОГО (ФОРМА 043/у)
 * В амбулаторной стоматологии применяется выписка из Формы 043/у
 * (Приказ Минздрава СССР № 1030 / регламенты РФ), а не госпитальная форма 003/у.
 * Схема сохраняет обратную совместимость с кодом 003-В/у при стоматологическом приоритете Формы 043/у.
 * ═══════════════════════════════════════════════════════════════════════════
 */
