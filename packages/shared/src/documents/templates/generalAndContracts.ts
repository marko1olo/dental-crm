...
<div class="doc-wrapper">
  ...
  <div class="doc-subtitle">Заполняется перед началом любого медицинского вмешательства (Приказ МЗ РФ № 804н, 1051н)</div>
...
<div class="doc-wrapper">
  ...
  <ul class="doc-list">
    ...
    <li>Соблюдение индивидуальной гигиены полости рта (индекс гигиены Green-Vermillion не более 1.6).</li>
