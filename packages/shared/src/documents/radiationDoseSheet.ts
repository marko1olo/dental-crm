...
export const dentalRadiologyStudyLabels: Record<DentalRadiologyStudyType, string> = {
...
export const DEFAULT_EFFECTIVE_DOSES_MSV: Record<DentalRadiologyStudyType, number> = {
