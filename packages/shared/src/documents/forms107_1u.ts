...
export const DENTAL_PRESCRIPTION_DRUG_CATALOG: readonly DentalPrescriptionDrugPreset[] = [
	...
	},
	{
		...
		tradeNameRu: "Кларитромицин (Клацид 500 мг)",
		activeSubstanceRu: "Кларитромицин",
		category: "antibiotic",
		categoryLabel: "Антибиотик резерва (макролид при аллергии на пенициллины)",
	...
	},
	{
		...
		category: "antibiotic",
		categoryLabel: "Антибиотик комбинированный (фторхинолон + нитроимидазол)",
		latinRp: "Rp.: Tab. 'Cifran ST' (Ciprofloxacini 500 mg + Tinidazoli 600 mg)",
		formRu: "таблетки, покрытые оболочкой",
		dosageRu: "500 мг + 600 мг",
		quantityLabel: "N. 10 (таблетки)",
		dispenseLatin: "D.t.d. N 10 in tab.",
		signaRu: "S. Внутрь по 1 таблетке 2 раза в сутки после еды через каждые 12 часов, запивая водой, курс 5 дней (пародонтальный абсцесс, перикоронит).",
		recommendedForIcd10: ["K04.4", "K05.2", "K05.3", "K08.1"],
		defaultValidityDays: "60",
	},
	{
	...
	},
	{
		...
		category: "gastroprotective",
		categoryLabel: "Эубиотик / Пробиотик (защита микробиоты)",
