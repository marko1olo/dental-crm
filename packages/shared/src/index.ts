...
export const documentKindSourceMetadata = {
	...
	treatment_plan: {
		...
		sourceNote:
			"План должен брать услуги и суммы из серверных фактов пациента/визита, а не из свободного текста браузера.",
		sourceCheckedAt: documentSourceCheckedAt,
	},
	treatment_plan_acceptance: {
		sourceStatus: "clinic_template",
...
export type DenteWhatsappBotConfig = z.infer<
	typeof denteWhatsappBotConfigSchema
>;
...
export type UpdateDenteWhatsappBotConfigInput = z.infer<
	typeof updateDenteWhatsappBotConfigSchema
>;
...
export type UpdateDenteMaxBotConfigInput = z.infer<
	typeof updateDenteMaxBotConfigSchema
>;
