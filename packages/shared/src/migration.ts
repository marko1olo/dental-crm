 ...
 */
export const migrationQuarantineReasonTitles: Record<MigrationQuarantineReason, string> = {
...
export const migrationAnalyzeRequestSchema = z.object({
...
export const migrationRollbackResponseSchema = z.object({
  runId: z.string(),
  status: migrationRunStatusSchema,
  deletedByEntity: z.array(z.object({
    entityKind: migrationEntityKindSchema,
    deleted: z.number(),
