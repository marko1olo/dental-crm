 ...
 */
export function convertRubToForeignCurrency(input) {
 ...
 */
export function formatCurrencyAmount(amount, currency, isMinorUnit = false) {
 ...
 */
export function calculateMedicalTourismQuote(input) {
