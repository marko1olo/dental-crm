 ...
 */
export function validateOneCParty(party) {
    const errors = [];
    if (party.inn) {
 ...
 */
export function resolveOneCOperationName(docType) {
    switch (docType) {
        case "invoice":
 ...
 */
function renderOneCItemXml(item) {
 ...
 */
function renderOneCDocumentXml(doc, clinic) {
 ...
 */
export function generateOneCEnterpriseXml(params) {
