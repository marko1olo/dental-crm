...
export const STAGE_CATEGORY_META = {
    hygiene_sanitation: {
 ...
 */
export function calculateStagePaymentDistribution(grandTotalKopecks, stagePercentages, stageTitles = []) {
 ...
 */
export function recalculateTreatmentPlanTotals(stages) {
    let planSubtotal = 0;
    let planDiscount = 0;
