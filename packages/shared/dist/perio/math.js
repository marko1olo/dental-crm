import { PERIO_LOWER_ARCH_TEETH, PERIO_SITE_KEYS, PERIO_UPPER_ARCH_TEETH, } from "./types.js";
/**
 ...
 */
export function isFurcationEligibleTooth(toothNumber) {
 ...
 */
export function generateFullMouthProbingSequence(teeth) {
    const activeTeethMap = new Map();
 ...
 * - Grade C (Rapid): > 1.0
 */
export function calculateBoneLossAgeRatio(boneLossPercent, patientAgeYears) {
 ...
 */
export function estimateBoneLossPercentFromTeeth(teeth, maxCalMm) {
 ...
 */
export function getProbingDepthColor(depthMm) {
    if (depthMm <= 3) {
        return {
