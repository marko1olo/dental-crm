 ...
 */
export const DEFAULT_LAB_TURNAROUND_DAYS = {
    crown: 7,
    bridge: 10,
    denture: 14,
    implant: 10,
 ...
 */
export function isLabOrderDelayed(order, now = new Date()) {
 ...
 */
export function canTransitionLabOrderStatus(current, target) {
    if (current === target)
        return true;
    const transitions = {
