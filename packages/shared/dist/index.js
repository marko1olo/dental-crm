 ...
 */
export const VALID_FDI_TOOTH_NUMBERS = new Set([
	// Постоянные зубы
...
export function isValidFdiToothNumber(value) {
	return (
		typeof value === "number" &&
...
const spokenAnatomicToothMap = spokenAnatomicToothQuadrants.flatMap(
