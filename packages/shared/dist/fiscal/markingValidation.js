 ...
 */
export const DENTAL_MDLP_MARKING_CATALOG = {
 ...
 */
export function isValidGs1Checksum(gtin) {
 ...
 */
export function parseChestnyZnakDataMatrix(rawInput) {
 ...
 */
export function buildFfd12Tag2000MarkingPayload(descriptor) {
    return {
