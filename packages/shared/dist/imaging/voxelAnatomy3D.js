 ...
 * ═══════════════════════════════════════════════════════════════════════════
 */
export function normalizeVoxelSpacing(input) {
 ...
 */
export function measure3DDistanceMm(p1, p2, voxelSpacing = { x: 0.2, y: 0.2, z: 0.5 }) {
 ...
 */
export function distancePointToSegment3DMm(point, segStart, segEnd, voxelSpacing) {
    const sp = normalizeVoxelSpacing(voxelSpacing);
 ...
 */
export function measureDistanceToMandibularNerve(implantApex, nerveTrajectoryPoints, voxelSpacing = { x: 0.2, y: 0.2, z: 0.5 }) {
    const sp = normalizeVoxelSpacing(voxelSpacing);
    ...
    let bestClosestPoint = nerveTrajectoryPoints[0];
 ...
 */
export function measureDistanceToMaxillarySinus(alveolarCrestPoint, sinusFloorPoint, voxelSpacing = { x: 0.2, y: 0.2, z: 0.5 }) {
    const sp = normalizeVoxelSpacing(voxelSpacing);
