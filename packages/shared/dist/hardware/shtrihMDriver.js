 ...
 */
export function computeShtrikhLrc(data) {
    let lrc = 0;
 ...
 */
export function buildShtrikhCommandPacket(commandCode, data = new Uint8Array(0)) {
 ...
 */
export function parseShtrikhResponsePacket(rawBuffer) {
 ...
 */
export function parseShtrikhErrorCode(code) {
    const errors = {
        0x00: "Ошибок нет",
