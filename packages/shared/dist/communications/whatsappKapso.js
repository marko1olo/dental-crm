 ...
 */
export function buildWhatsappNamedParameters(context) {
    if (!context)
        return [];
 ...
 */
export function buildWhatsappTemplatePayload(toNumber, templateName, languageCode, parameters) {
    return {
 ...
 */
export function buildWhatsappInteractiveButtons(toNumber, bodyText, buttons, headerText, footerText) {
 ...
 */
export function buildWhatsappInteractiveList(toNumber, bodyText, buttonTitle, sections, headerText, footerText) {
    return {
        messaging_product: "whatsapp",
        recipient_type: "individual",
        to: toNumber,
