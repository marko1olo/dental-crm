...
export const RECALL_INTERVAL_MONTHS = {
    hygiene: 6,
    checkup: 12,
    ortho_review: 1,
    implant_review: 6,
 ...
 */
export function normalizeDueMonthString(d = new Date()) {
 ...
 */
export function calculateNextRecallDueMonth(fromDate = new Date(), categoryKey = "checkup") {
 ...
 */
export function renderRecallReminderTemplate(templateText, context = {}) {
 ...
 */
export function planCascadeDispatchSchedule(config, baseDate = new Date()) {
    const steps = [];
 ...
 */
export function evaluateCascadeStepAdvance(outcome, stopOnAnyResponse = true) {
