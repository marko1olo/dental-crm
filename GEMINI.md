...
16. **Суверенитет масштаба: от врача на аренде (1 кресло) до сетевого холдинга (Мандат 8n)**: Соло-врачу — полная автономия кассы, отсутствие обязательных ассистентов в расписании, печать договоров `_____` без 403, списание анестетиков пакетом. Сети — изоляция БД, RBAC, фоновый аудит начмеда (CMO). Система НИКОГДА не заходит в тупик (Zero Dead-Ends) и масштабируется без миграций.
