...
export type CameraScaleMode = 'fit' | 'fitAspect' | 'fitWidth' | 'fitHeight' | 'absolute';
...
export interface ViewportCameraBase<TAnchorWorld = unknown, TScale = number> extends CameraFrame<TAnchorWorld, TScale> {
}
