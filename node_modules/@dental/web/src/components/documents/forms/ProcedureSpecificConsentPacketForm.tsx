...
export function ProcedureSpecificConsentPacketForm({
	activeDoctor,
	dashboard,
	...
	return (
		<article className="document-payload-card">
			<div>
				...
				<p>
					Приложение к согласию для конкретной процедуры: тип, зона, материалы,
					риски, альтернативы и послеоперационные ограничения.
				</p>
			</div>
				...
				<div className="document-payload-collapsed-content">
					...
					<label>
						...
						<textarea
							...
							placeholder={
								dashboard?.activeVisit?.complaint ?? "показание к процедуре"
							}
							rows={2}
						/>
					</label>
					...
					<label>
						...
						<textarea
							...
							onChange={(event) =>
								setProcedureConsentPatientRiskFactors(event.target.value)
							}
							rows={3}
						/>
					</label>
