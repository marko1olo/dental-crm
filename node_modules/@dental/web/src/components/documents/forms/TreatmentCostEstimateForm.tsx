...
export function TreatmentCostEstimateForm({
	activeDoctor,
	money,
	...
	return (
		<article className="document-payload-card">
			<div>
				<h3>Смета лечения</h3>
				<p>
					Предварительный расчет с составом услуг, сроком действия, исключениями
					и правилами изменения цены.
				</p>
			</div>
				...
				<div className="document-payload-collapsed-content">
					...
					<div className="document-payload-row">
						<label>
							...
							<input
								...
								onChange={(event) =>
									setTreatmentEstimatePatientOrPayerFullName(event.target.value)
								}
								placeholder={
									treatmentEstimatePatientOrPayerFullNameValue() ||
					...
					<label>
						...
						<textarea
							...
							onChange={(event) =>
								setTreatmentEstimatePaymentMilestoneNotes(event.target.value)
							}
							rows={3}
						/>
						<div className="quick-chips-row">
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setTreatmentEstimatePreliminaryConfirmed(event.target.checked)
							}
						/>
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setTreatmentEstimateFiscalNoticeConfirmed(event.target.checked)
							}
						/>
					...
					<label className="document-payload-checkbox">
						<input
							...
							type="checkbox"
							onChange={(event) =>
								setTreatmentEstimateChangeRulesConfirmed(event.target.checked)
							}
						/>
