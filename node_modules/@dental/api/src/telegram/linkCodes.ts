...
import type { DenteTelegramLinkCode } from "@dental/shared";

export async function listDenteTelegramLinkCodes(
  organizationId: string,
  limit: number = 50
): Promise<DenteTelegramLinkCode[]> {
...
): Promise<DenteTelegramLinkCode | null> {
