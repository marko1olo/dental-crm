...
function assertSecurityConfiguration(): void {
  ...
  // Вне production послабления включены по умолчанию и не требуют настройки .env.
  console.warn(
    "[security] Режим разработки: демо-вход, заголовок x-organization-id и код портала 0000 активны. " +
      "В production всё это выключено автоматически."
  );
}
