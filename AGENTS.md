...
## 🛑 МАНДАТ 8n: СУВЕРЕНИТЕТ МАСШТАБА: ОТ ВРАЧА НА АРЕНДЕ (1 КРЕСЛО) ДО СЕТЕВОГО ХОЛДИНГА (ZERO DEAD-ENDS & SCALE ADAPTABILITY)
1. **Целевой спектр клиник:** Система спроектирована для одинаково комфортной работы соло-врача на аренде кресла (ИП/самозанятый), стандартной клиники (3–5 кресел) и федеральной сети (10+ кресел, несколько филиалов).
...
3. **Сетевой холдинг:** строгая изоляция филиалов на уровне БД, RBAC, аудит начмеда (CMO) в фоновом режиме аналитики без блокировки приёма у кресла, маркировка МДЛП («Честный Знак»), ЕГИСЗ (РЭМД).
